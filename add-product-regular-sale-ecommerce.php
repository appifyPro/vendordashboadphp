                        ...
                        <div class="wizard border-0 bg-none round-10">
                           <div class="wizard-inner" style="display: none;">
                              ...
                              <ul class="nav nav-tabs" role="tablist">
                                 ...
                                 <li role="presentation" class="disabled">
                                    <a href="#sizevariants" data-toggle="tab" aria-controls="sizevariants"
                                       role="tab"><span class="round-tab">4</span>
                                       <i>Step 4</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                    <a href="#itemvariants" data-toggle="tab" aria-controls="itemvariants"
                                       role="tab"><span class="round-tab">5</span>
                                       <i>Step 5</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                    <a href="#photosvideo" data-toggle="tab" aria-controls="photosvideo"
                                       role="tab"><span class="round-tab">6</span>
                                       <i>Step 6</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                    <a href="#manageOrder" data-toggle="tab" aria-controls="manageOrder"
                                       role="tab"><span class="round-tab">7</span>
                                       <i>Step 7</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                    <a href="#uploadvideo" data-toggle="tab" aria-controls="uploadvideo"
                                       role="tab"><span class="round-tab">8</span>
                                       <i>Step 8</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                 ...
                                 <li role="presentation" class="disabled">
                                    <a href="#calculation" data-toggle="tab" aria-controls="calculation"
                                       role="tab"><span class="round-tab">11</span>
                                       <i>Calculation</i></a>
                                 </li>
                                 <li role="presentation" class="disabled">
                                    <a href="#shippingcost" data-toggle="tab" aria-controls="shippingcost"
                                       role="tab"><span class="round-tab">12</span>
                                       <i>shipping cost</i></a>
                                 </li>
                              </ul>
                           </div>
                           <form role="form" action="index.html" class="login-box">
                              <div class="tab-content" id="main_form" style="padding-top: 0;">
                                 ...
                                 <div class="tab-pane active" id="productinfo">
                                    <!--<div class="row mb-5 mt-3 pb-3 mb-rbottom">
                                       <div class="col-12 col-lg-6 m-auto d-flex pl-2">
                                          <a class="menuhover align-self-start tooltip position-relative"
                                          ...
                                          <div class="bg-white round-10 shop-wrap pt-3 mb-5 pb-5 aac-index">
                                                      ...
                                                      <div class="col-12">
                                                               ...
                                                               <div class="bg-white py-4 px-4">
                                                                  ...
                                                                  <div class="top-search physical_part">
                                                                     <div class="physical_input_box_part">
                                                                        <div
                                                                           class="physical_input_box bg-secondary radius-4 dropdown">
                                                         ...
                                                         <div class="row align-items-center d-none sub-cat-choose mb-5">
                                                            <div class="col-12">
                                                               ...
                                                               <div class="bg-white py-4 px-4">
                                                                  <select class="rating-star sub-category-select py-0"
                                                                     name="category">
                                             ...
                                             <div class="border-top bg-white text-center py-4  fixed-bottom">
                                                <div
                                                   ...
                                                   <div>
                                                      <a type="button" class="cursor-pointer font-14 edit-company-info"
                                                         href="vendor-dashboard.php">Back to Dashboard</a>
                                                   </div>
                                                   <div class="px-4 font-26 font-weight-500 desktop-view pt-2">List your
                                                      Product
                                                   </div>
                                                   ...
                                                   <div class="row">
                                                      <div class="col-12 col-lg-6">
                                                         <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            ...
                                                            <label
                                                               class="btn btn-primary btn2 border-right border-left">
                                                               <input type="radio" name="options" autocomplete="off">
                                                               Digital Product
                                                            </label>
                                                         </div>
                                          ...
                                          <div class="bg-white round-10 shop-wrap pt-3 pb-5 mt-5 aac-index">
                                             ...
                                             <div class="position-relative px-5">
                                                <div class="head py-3">
                                                   ...
                                                   <p class="font-14">If this product is not available for delivery than
                                                      the customer pickup it in your store</p>
                                                </div>
                                                   ...
                                                   <div class="row">
                                                      ...
                                                      <div class="col-12 col-lg-10 d-flex">
                                                         <div class="categories extras-add d-flex">
                                                            <label for="delivery" class="extras-add-label p-0 m-0"
                                                               style="background: none !important">
                                                               <a href="#"><span
                                                                     class="extras-add-title font-16 font-weight-400">Product
                                                                     available for delivery</span></a>
                                                               <input type="radio" name="productAvailable" id="delivery"
                                                                  class="ml-3" checked="">
                                                            </label>
                                                            <label for="pickup" class="extras-add-label p-0 m-0 ml-5"
                                                               style="background: none !important">
                                                               <a href="#"><span
                                                                     class="extras-add-title font-16 font-weight-400">Product
                                                                     available for pickup</span></a>
                                                               <input type="radio" name="productAvailable" class="ml-3"
                                                                  id="pickup">
                                                            </label>
                                                         </div>
                                                      </div>
                                       ...
                                       <div class="lefttab-part">
                                          <div class="d-flex align-items-start pt-3 mb-4">
                                             ...
                                             <div class="px-4 font-26 font-weight-500 desktop-view pt-2">Product Detail
                                                Page Ecommerce<span class="line-height1.5 font-14 d-block">Please fill
                                                   in the informations they are required to sell your products on
                                                   StayToEnjoy</span>
                                             </div>
                                          </div>
                                                   ...
                                                   <div class="row">
                                                      ...
                                                      <div class="col-md-4">
                                                         <div class="form-group">
                                                            <input type="text"
                                                               class="form-control product-sku bg-secondary default-placeholder"
                                                               value="" placeholder="Cotton, PLastic, Steel e.g.">
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <!--End New Field-->
                                                      ...
                                                      <div class="col-md-9">
                                                         <div class="ex-tags-input">
                                                            <input type="text" id="variantWant"
                                                               value="Ecommerce,Computer,Smartphones"
                                    ...
                                    <div class="d-flex">
                                       <div class="lefttab-part">
                                          <div class="position-relative shop-wrap shadow-none">
                                                         ...
                                                         <div class="card border-0 shadow w-100 h-100">
                                                            <div class="card-body p-0">
                                                               <div class="d-flex align-items-center">
                                                                  ...
                                                                  <div class="col-6">
                                                                     <p class="font-16 ml-4">Men T-Shirt</p>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                                               ...
                                                               <div class="d-flex align-items-center">
                                                                  ...
                                                                  <div class="target-wrap">
                                                                     <a href="javascript:void(0);"
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#target-modal">Select Target
                                                                        Group</a>
                                                                     <ul
                                             ...
                                             <div class="d-block">
                                                <div class="d-flex align-items-start pt-0 mb-4 pl-3">
                                                            ...
                                                            <div class="card border-0 shadow w-100"
                                                               ...
                                                               <div class="card-body p-4">
                                                                  <div class="row align-items-center">
                                                                     <div class="col-12">
                                                                        <span
                                                                           class="font-16 addedTag bg-secondary radius-5 text-dark px-5 py-3 d-inline-block mr-3 position-relative">
                                                                           White
                                                                        ...
                                                                        <a href="#"
                                                                           class="font-16 blue-text font-weight-400 text-muted active"
                                                                           data-target="#color-modal"
                                                                           data-toggle="modal">+Add Colors</a>
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                                         <div class="col-12 text-right"><button type="submit"
                                                               class="bttn bttn-default font-blue ml-auto mt-4 gray-btn">Generate</button>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                                      ...
                                                      <div class="row ">
                                                         <div class="col-12 mb-5">
                                                            <div class="card border-0 shadow w-100 index-wrap"
                                                               ...
                                                               <div class="card-body px-5 py-4">
                                                                  <div class="form-body">
                                                                     <h3 class="font-24 mt-3 mb-4">White</h3>
                                                                     <form action="/action_page.php">
                                                                        <div class="pricing-option-wrapper">
                                                                           <div
                                                                              class="d-flex pcol-flex mt-2 mb-5 align-self-center">
                                                                              <div
                                                                                 class="col-auto pl-0 mt-4 align-self-center">
                                                                                 <span class="col-text font-16">S</span>
                                                                              </div>
                                                                              <div class="col-1 pr-1">
                                                                                 <label
                                                                                    class="field-title font-14">Stock</label>
                                                                                 <input type="text"
                                                                              ...
                                                                              <div class="col-auto pl-0 pt-5">
                                                                                 <button
                                                                                    class="close-red-text field-title tooltip position-relative">X<span
                                                                                       class="tooltiptext custom pt-1 px-3 font-11">lorem
                                                                                       ipsum</span></button>
                                                                              </div>
                                                                           </div>
                                                                           ...
                                                                           <div
                                                                              class="d-flex pcol-flex mt-4 pt-2 mb-2 align-self-center">
                                                                              <div
                                                                                 class="col-auto pl-0 mt-4 align-self-center">
                                                                                 <span class="col-text font-16">M</span>
                                                                              </div>
                                                                              <div class="col-1 pr-1">
                                                                                 <label
                                                                                    class="field-title font-14">Stock</label>
                                                         ...
                                                         <div class="col-12 mb-5">
                                                            <div class="card border-0 shadow w-100 index-wrap"
                                                               ...
                                                               <div class="card-body px-5 py-4">
                                                                  <div class="form-body">
                                                                     <h3 class="font-24 mt-3 mb-4">Black</h3>
                                                                     <form action="/action_page.php">
                                                                        <div class="pricing-option-wrapper">
                                                                           <form action="/action_page.php">
                                                                              <div class="pricing-option-wrapper">
                                       ...
                                       <div class="lefttab-part">
                                          <div class="position-relative">
                                             <div class="d-flex align-items-start pt-3 mb-4">
                                                ...
                                                <div class="px-4 font-26 font-weight-500 desktop-view pt-2">Stock
                                                   Overview<span class="line-height1.5 font-14 d-block">Lorem ipsum
                                                      dolor dummy text here </span>
                                                </div>
                                             </div>
                                             <div class="bg-white round-10 shop-wrap py-3 mb-5 ml-4">
                                                   ...
                                                   <div class="grey-panel p-5">
                                                      ...
                                                      <div class="row align-items-center">
                                                         <div class="col-12 col-lg-3 align-self-center font-blue">
                                                            <label
                                                               class="form-group tooltip position-relative mb-3 font-16">
                                                               Stock&nbsp;&nbsp;<i
                                                                  class="fa fa-info-circle text-dark font-16"></i>
                                                               <span
                                                                  class="tooltiptext custom p-2 px-3 font-11">Stock</span>
                                                            </label>
                                                            <div class="form-group">
                                                               <input type="text"
                                                                  class="form-control default-placeholder" value=""
                                                                  placeholder="0" readonly />
                                                            </div>
                                                         </div>
                                                         <div
                                                            class="col-12 col-lg-3 align-self-center font-16 font-blue">
                                                            <label
                                                               class="form-group tooltip position-relative mb-3 font-16">
                                                               Min. order quantity&nbsp;&nbsp;<i
                                                                  class="fa fa-info-circle text-dark font-16"></i>
                                                               <span class="tooltiptext custom p-2 px-3 font-11">Min.
                                                                  order quantity</span>
                                                            </label>
                                                            <div class="form-group">
                                                               <input type="text"
                                                         ...
                                                         <div class="col-12 col-lg-3">
                                                            <label
                                                               class="form-group tooltip position-relative mb-3 font-16">
                                                               Max. order quantity&nbsp;&nbsp;<i
                                                                  class="fa fa-info-circle text-dark font-16"></i>
                                                               <span class="tooltiptext custom p-2 px-3 font-11">Max.
                                                                  order quantity</span>
                                                            </label>
                                                            <div class="form-group">
                                                               <input type="text"
                                                      ...
                                                      <div class="row align-items-center">
                                                         <div
                                                            ...
                                                            <label
                                                               ...
                                                               Delivery Time&nbsp;&nbsp;<i
                                                                  class="fa fa-info-circle text-dark font-16"></i>
                                                               <span
                                                                  class="tooltiptext custom p-2 px-3 font-11">Delivery
                                                                  Time</span>
                                                            </label>
                                                            <div class="form-group">
                                                               <input type="text"
                                                         ...
                                                         <div class="col-12 col-lg-3">
                                                            <div class="bg-secondary-pro mt-2">
                                                               <form>
                                                                  <div
                                                                     class="our-custom-select w-100 custom-select-sale">
                                                                     <div class="selected-value">
                                                                        <div
                                                                           class="sel-value font-16 font-blue overflow-hidden"
                                                                           style="white-space:nowrap">Select</div>
                                                                        <input type="text" name="" readonly value="All"
                                                                           disabled id="mainCategory" />
                                                                     </div>
                                                                     <ul class="options scroll-dropdown px-4 scroll-design scrollbox set-drpdn-big"
                                                                        style="height:132PX;">
                                                                        <li>Days</li>
                                                         ...
                                                         <div class="col-12 col-lg-3">
                                                            <div
                                                               class="border-none bg-none form-control mt-3 d-flex align-self-center">
                                                               <div
                                                                  class="form-group d-flex align-items-center font-16 justify-content-between w-100 mt-2 mb-0">
                                                                  Free shipping
                                                      ...
                                                      <div class="row">
                                                         <div
                                                            ...
                                                            <button type="submit"
                                                               ...
                                                               draft</button>
                                                            <button type="button"
                                                               class="image-new-right-offer bttn bttn-primary ml-3 next-step">Next</button>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                    ...
                                    <div class="d-flex">
                                       <div class="lefttab-part">
                                          <div class="d-flex align-items-start pt-3 mb-4">
                                             ...
                                             <div class="px-4 font-26 font-weight-500 desktop-view pt-2">Package
                                                Dimensions & Costs<span class="line-height1.5 font-14 d-block">Add the
                                                      ...
                                                      <div class="finance  w-100 domestic-shipping">
                                                         <div class="row mb-4 packagewrap">
                                                            <div class="col-md-12">
                                                               <div class="form-group row mb-0 align-items-center">
                                                                  <div class="col-md-2">
                                                                     <label class="font-14 mt-4">Choose
                                                                        Dimension</label>
                                                                  </div>
                                                                  <div class="col-md-2 col mb-3">
                                                                     ...
                                                                     <div
                                                                        ...
                                                                        <div class="selected-value">
                                                                           ...
                                                                           <input type="text" name="" readonly
                                                                              value="All" disabled id="select_weight" />
                                                                        </div>
                                                                  ...
                                                                  <div class="col-md-3 pl-0 col mb-3">
                                                                     <label class="font-14">Width</label>
                                                                     <div class="input-group w-100">
                                                                        <input type="text" class="form-control mt-0"
                                                                           placeholder="500..." />
                                                                  ...
                                                                  <div class="col-md-3 pl-0 col mb-3">
                                                                     <label class="font-14">Height</label>
                                                                     <div class="input-group w-100">
                                                                        <input type="text" class="form-control mt-0"
                                                                           placeholder="200..." />
                                                                        <span class="cmtxt" id="dimension1">cm</span>
                                                                  ...
                                                                  <div class="col-md-2 pl-0 col mb-3">
                                                                     <label class="font-14">Length</label>
                                                                     <div class="input-group w-100">
                                                                        <input type="text" class="form-control mt-0"
                                                                           placeholder="100..." />
                                                                        <span class="cmtxt" id="dimension1">cm</span>
                                                         ...
                                                         <div class="row mb-4 packagewrap">
                                                            <div class="col-md-12">
                                                               <div class="form-group row mb-0 align-items-center">
                                                                  <div class="col-md-2">
                                                                     <label class="font-14 mt-4">Choose Weight</label>
                                                                  </div>
                                                                  <div class="col-md-2 col mb-3">
                                                                     <label class="font-14"></label>
                                                                     <div
                                                                  ...
                                                                  <div class="col-md-3 col mb-3">
                                                                     <label class="font-14">Weight</label>
                                                                     <div class="input-group w-100">
                                                                        <input type="text" class="form-control mt-0"
                                                                           placeholder="0.4..." />
                                                         ...
                                                         <div class="row mb-4 packagewrap">
                                                            <div class="col-md-12">
                                                               <div class="form-group row mb-0">
                                                                  <div class="col-md-2">
                                                                     <label class="font-14 mt-4"></label>
                                                                  </div>
                                                                  <div class="col-md-2 col mb-3">
                                                                     <label
                                                                        class="font-14 tooltip position-relative">Packaging
                                                                        unit&nbsp;&nbsp;<i
                                                                           class="fa fa-info-circle text-dark font-16"></i>
                                                                        <span
                                                                           class="tooltiptext custom p-2 px-3 font-11">lorem
                                                      ...
                                                      <div class="finance  w-100 domestic-shipping">
                                                         <div class="row mb-4 align-items-center">
                                                            <div class="col-md-3 align-self-center">
                                                               <label class="mt-2 tooltip position-relative">
                                                                  Domestic Shipping&nbsp;&nbsp;<i
                                                                     class="fa fa-info-circle text-dark font-16"></i>
                                                                  <span
                                                                     class="tooltiptext custom p-2 px-3 font-11">lorem
                                                            ...
                                                            <div class="col-md-5">
                                                               <div class="our-custom-select custom-select-sale">
                                                                  <div class="selected-value">
                                                                     <div class="sel-value font-16 overflow-hidden"
                                                                        style="white-space:nowrap">Flat-rate same cost
                                                                        for all buyers</div>
                                                                     <input type="text" name="" readonly value="All"
                                                                        disabled id="sel1" />
                                                                  </div>
                                                            ...
                                                            <div class="col-md-4">
                                                               <!--<div class="input-group mt-2">
																					<div class="custom-control price-custom-control custom-radio">
																						...
																						<input type="radio" class="d-inline-block mb-1" name="domestic_shipping">Ship Shipping CostTable
																						</label>
																					</div>
																				</div>-->
                                                            </div>
                                                         ...
                                                         <div class="row mb-4">
                                                            <div class="col-md-3">
                                                               <label class="mt-3 tooltip position-relative">
                                                                  Package Type&nbsp;&nbsp;<i
                                                                     class="fa fa-info-circle text-dark font-16"></i>
                                                                  <span
                                                                     class="tooltiptext custom p-2 px-3 font-11">lorem
                                                                  ...
                                                                  <div class="col-md-12 d-flex">
                                                                     <div class="input-group">
                                                                        <input type="text" class="form-control"
                                                                           placeholder="Add you own package description">
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         ...
                                                         <div class="row mb-4">
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                               <div class="row">
                                                                  <div class="col-md-12 d-flex">
                                                                     <div
                                                                        class="input-group align-items-center d-flex position-relative">
                                                                        <input type="text"
                                                                           class="form-control tab-font-12"
                                                                           placeholder=" 0,00">
                                                            ...
                                                            <div class="col-md-4 text-right form-group pr-0">
                                                               <div class="input-group mt-3">
                                                                  <div
                                                                     class="custom-control price-custom-control custom-radio">
                                                                     <label class="radio-inline mb-0">
                                                                        <input type="radio" name="domestic_shipping"
                                                                           class="d-inline-block mb-1">Free Shipping
                                                                     </label>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         ...
                                                         <div class="row mb-4  align-items-center">
                                                            ...
                                                            <div class="col-md-4">
                                                               <div class="form-group">
                                                                  <a href="#itemlocation" data-toggle="modal"
                                                                     data-target="#itemlocation"><button
                                                                        class="item-location">Change Item
                                                                        Location</button></a>
                                                               </div>
                                                            </div>
                                                         </div>
                                                         <!--popup-->
                                                         <!-- Modal -->
                                                         <div class="modal fade feedbackmodal" id="itemlocation"
                                                            role="dialog">
                                                               ...
                                                               <div class="modal-content modal-content-delete">
                                                                  ...
                                                                  <div class="modal-body p-0 mb-3 mt-4 border-bottom">
                                                                     <div class="pl-3 font-18 ">
                                                                        <p style="padding:20px;">You want to change item
                                                                           location.</p>
                                                                        <p></br>
                                                                  ...
                                                                  <div class="modal-footer border-0">
                                                                     <button type="button"
                                                                        class="btn btn-primary mr-4 popdiscard"
                                                                        data-dismiss="modal"> Cancel</button>
                                                                     <button type="button"
                                                                        class="btn btn-primary popbutton"
                                                                        data-dismiss="modal"> Submit</button>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                                         <div class="modal fade feedbackmodal snooze"
                                                            id="itemlocation1">
                                                         ...
                                                         <div class="row mb-5">
                                                            ...
                                                            <div class="col-md-5">
                                                               <div class="form-group">
                                                                  <div class="our-custom-select custom-select-sale">
                                                                     <div class="selected-value">
                                                                        <div class="sel-value  font-16">Select a period
                                                                        </div>
                                                                        <input type="text" name="" readonly value="All"
                                                                           disabled id="sel1" />
                                                                     </div>
                                                         ...
                                                         <div class="modal-dialog">
                                                            <div class="modal-content">
                                                               ...
                                                               <div class="modal-header">
                                                                  ...
                                                                  <button type="button" class="close"
                                                                     data-dismiss="modal" style="opacity: 1;">×</button>
                                                               </div>
                                                               <!-- Modal body -->
                                                               ...
                                                               <div class="modal-footer">
                                                                  <div class=" d-flex  flex-row-reverse text-right">
                                                                     <button class="bttn bttn-primary ml-2 "
                                                                        style="width: 120px;">Add</button>
                                                                     <button class="bttn btn-cancel"
                                                                        data-dismiss="modal">Cancel</button>
                                                                  </div>
                                                               </div>
                                                            </div>
                                    ...
                                    <div class="d-flex">
                                       <div class="lefttab-part">
                                          <div class="d-flex align-items-start pt-3 mb-4">
                                             ...
                                             <div class="px-4 font-26 font-weight-500 desktop-view pt-2">Withdrawal<span
                                                   class="line-height1.5 font-14 d-block">
                                                   ...
                                                   <div class="finance withdrawal" style="width: 100%">
                                                      <div class="row p-3 align-items-center">
                                                         <div class="col-md-3 form-group">
                                                            <label
                                                               class="form-group m-0 font-16 font-blue tooltip position-relative">
                                                               Withdrawal options <i
                                                                  class="fa fa-info-circle text-dark font-16"></i>
                                                               <span class="tooltiptext custom p-2 px-3 font-11">lorem
                                                                  ipsum</span>
                                                            </label>
                                                            ...
                                                            <div class="form-group">
                                                               <div class="col-md-12">
                                                                  <div class="input-group ">
                                                                     <div
                                                                        class="custom-control price-custom-control custom-radio"
                                                                        style="padding-left: 0;" data-toggle="collapse"
                                                                        data-target="#return">
                                                                        <label class="radio-inline">
                                                                           <input type="radio" name="returns"
                                                                              class="d-inline-block mb-1">National
                                                                           Returns Accepted
                                                                        </label>
                                                                     </div>
                                                                  </div>
                                                         ...
                                                         <div class="col-md-4 form-group">
                                                            <div class="form-group">
                                                               <div class="col-md-12">
                                                                  <div class="input-group ">
                                                                     <div
                                                                        class="mrt-top-cust custom-control price-custom-control custom-radio"
                                                                        style="padding-left: 0;" data-toggle="collapse"
                                                                        data-target="#return1">
                                                                        <label class="radio-inline">
                                                                           <input type="radio" name="returns"
                                                                              class="d-inline-block mb-1">International
                                                                           Returns Accepted
                                                                        </label>
                                                                     </div>
                                                                  </div>
                                                      ...
                                                      <div class="row p-3">
                                                         ...
                                                         <div class="col-md-9">
                                                            <div class="form-group">
                                                               ...
                                                               <!-- <div id="editor"></div> -->
                                                               <p class="text-right text-secondary"><small>0/55</small>
                                                               </p>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   ...
                                                   <div class="row">
                                                      <div
                                                         ...
                                                         <button type="submit"
                                                            ...
                                                            draft</button>
                                                         <button type="submit"
                                                            class="bttn bttn-default  font-blue ml-3 sky-btn">Preview</button>
                                                         <button type="button"
                                                            class="bttn bttn-primary ml-3 next-step">Next</button>
                                                      </div>
                                                   </div>
                                                      ...
                                                      <table class="table calcu-table font-14">
                                                         <tbody>
                                                            <tr>
                                                               ...
                                                               <th style="border: 0;background-color: #F0F2F5;padding: 15px 40px 15px 15px !important; text-align: right; border-bottom: 1px solid rgba(5, 34, 76, 0.15);"" align="
                                                                  right">
                                                                  $ 530.00
                                                               </th>
                                                            </tr>
                                                            <tr>
                                                               ...
                                                               <td style="border: 0;background-color: #F0F2F5;padding: 15px 40px 15px 15px !important; border-bottom: 1px solid rgba(5, 34, 76, 0.15);"" align="
                                                                  right">
                                                                  $ 30.00
                                                               </td>
                                                            </tr>
                                                   ...
                                                   <div class="row">
                                                      <div
                                                         ...
                                                         <button type="submit"
                                                            ...
                                                            draft</button>
                                                         <button type="button"
                                                            class="bttn bttn-primary ml-3 next-step">List your
                                                            product</button>
                                                      </div>
                                                   </div>
                                                </div>
