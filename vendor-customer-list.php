   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Customer</div>
         </div>
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Customer</div>
      ...
      <div class="margin-0-auto exmt-10">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Customer
				<p class="d-block font-16 greyText-color">Find all Products you list </p>
			</div>-->
         <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5">
            <table id="vendor-customer-overview" class="display table table-responsive" style="width:100%">
               <thead>
                  <tr>
                     <th class="font-nunito font-15 text-dark text-capitalize cutomer">Customer</th>
                     <th class="font-nunito font-15 text-dark text-capitalize phone">Phone</th>
                     <th class="font-nunito font-15 text-dark text-capitalize email">Email</th>
                     <th class="font-nunito font-15 text-dark text-capitalize location">Location</th>
                     <th class="font-nunito font-15 text-dark text-capitalize createDate">Create Date</th>
                     <th class="font-nunito font-15 text-dark text-capitalize customerStatus">Status</th>
