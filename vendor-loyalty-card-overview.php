   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Loyalty Card Overview</div>
         </div>
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Loyalty Card Overview</div>
      ...
      <div class="margin-0-auto exmt-10">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Loyalty Card Overview
				<p class="d-block font-16 greyText-color">Find all Products you list </p>
			</div>-->
         <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5">
            <table id="vendor-loyalcard-overview" class="display table table-responsive" style="width:100%">
               <thead>
                  <tr>
                     <th class="font-nunito font-15 text-dark text-capitalize customer">Customer</th>
                     <th class="font-nunito font-15 text-dark text-capitalize phone">Phone</th>
                     <th class="font-nunito font-15 text-dark text-capitalize createDate">Create Date</th>
                     <th class="font-nunito font-15 text-dark text-capitalize cardID">card ID</th>
                     <th class="font-nunito font-15 text-dark text-capitalize overviewStatus">Status</th>
                     <th class="font-nunito font-15 text-dark text-capitalize point">point</th>
                     <th class="font-nunito font-15 text-dark text-capitalize raffle">raffle</th>
                     <th class="font-nunito font-15 text-dark text-capitalize redeemCard">Redeem card</th>
                     <th class="font-nunito font-15 text-dark text-capitalize action text-center" style="width: 75px;">
                        Action</th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     <td class="table-user" style="width: 14%;">
                     ...
                     <td class="text-body font-nunito" style="width: 12%;">
                        937-330-1634
                     </td>
                     <td class="text-body font-nunito" style="width: 10%;">
                        07/07/2018
                     </td>
                     <td class="text-body font-nunito" style="width: 10%;">
                        888-888-999-22
                     ...
                     <td class="text-body font-nunito" style="width: 5%;">
                        7/12
                     </td>
                     <td><span class="bg-secondary font-12 radius-5 badge color-default py-2">Yes</span></td>
                     <td style="width: 8%;"><a href="javascript:void(0);"
