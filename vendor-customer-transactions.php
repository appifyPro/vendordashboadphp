   ...
   <div class="right-side-section">
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Customer Transaction</div>
      ...
      <div class="margin-0-auto exmt-10">
         ...
         <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5">
            <table id="vendor-custTransaction-overview" class="display table table-responsive" style="width:100%">
               <thead>
                  <tr>
                     <th class="text-capitalize font-nunito font-15 customer">Customer</th>
                     <th class="text-capitalize font-nunito font-15 amount">Amount</th>
                     <th class="text-capitalize font-nunito font-15 createAt">Created at</th>
                     <th class="text-capitalize font-nunito font-15 paidAt">Paid at</th>
                     <th class="text-capitalize font-nunito font-15 payoutStatus">Status</th>
               ...
               <tbody>
                  <tr>
                     <td class="table-user" style="width: 5%;">
                        <img src="assets/images/users/avatar-4.jpg" alt="table-user" width="30"
                           class="mr-2 rounded-circle">
                        <a href="javascript:void(0);" class="text-body font-weight-600">Paul J. Friend</a>
                     </td>
                     <td class="font-14 text-muted" style="width: 2%;">
                        $176.41
                     </td>
                     <td class="font-14 text-muted" style="width: 5%;">
                  ...
                  <tr>
                     ...
                     <td>
                        <h5><span class="badge badge-info-lighten">Failed</span></h5>
                     </td>
                     <td class="text-center elipsis-click">
                        <button class="elipsis-click-icon dropdown-toggle" type="button" id="dropdownMenu2"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
