...
reader.onload = (function(theFile) {
 ...
 // Render thumbnail.
		var imgThumbnailElem = "<div class='RearangeBox imgThumbContainer'><img class='imgRemoveBtn' onclick='removeThumbnailIMG(this)' src='assets/img/garbage-can-icon.svg' alt=''><div class='IMGthumbnail' ><img  src='" + e.target.result + "'" + "title='" + theFile.name + "'/></div><div class='imgName'>" + theFile.name + "</div><span class='section-notice__main'>Must be over 500 pixels wide</span></div>";
...
function autocomplete(inp, arr) {
	...
	inp.addEventListener("input", function(e) {
		...
		pro.innerHTML += '<h2 class="textual-display">Can you sepcify that?</h2><span class="textual-display">Additional information optimizes your offer</span>';
 ...
 var courses = ["Introduction to Athropology","Introduction to Archaeology","Cultural Anthropology","Anthropology","Communication","Education","Education: Early Childhood","Education: Elementary Education with a Language and Culture Teaching Specialty","Education: Second Language / Elementary Education","Education: Secondary Education","Education: Special Education","English","Fine Arts","History","Pacific-Asian Studies","Philosophy","Political Science","Psychology","Sociology","Computer Science", "t shirt", "teppich", "tablet", "tommy hilfiger", "t shirt herren", "thermomix tm6", "taschenmesser", "tunika", "toaster", "t shirt men", "t shirt women"];
