...
<div
   class="main_body_content ml-0  bg-secondary create-ad-section return-management-system vendor-customer-transactions">
   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Customer Transactions</div>
         </div>
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Payouts</div>
      ...
      <div class="margin-0-auto exmt-10">
         <!--<div class="row align-items-start mb-4">
            <div class="col-12 col-lg-6">
               <div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Customer Transactions
         ...
         <div class="table-area">
            <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5 table-responsives">
               <table id="customer-order-list" class="display table table-responsive table-centered mb-0">
                  <thead>
                     <tr>
                        <th class="text-capitalize font-nunito font-15 paymentDate">Payment Date</th>
                        <th class="text-capitalize font-nunito font-15 type">Type</th>
                        <th class="text-capitalize font-nunito font-15 details">Details</th>
                        <th class="text-capitalize font-nunito font-15 amount">Amount</th>
                        <th class="text-capitalize font-nunito font-15 amount">Tax</th>
                        <th class="text-capitalize font-nunito font-15 paidOut">Paid Out</th>
                  ...
                  <tbody>
                     <tr>
                        <td class="font-14 text-muted">
                           August 05 2018 <small class="text-muted d-block">10:29 PM</small>
                        </td>
                        <td class="font-14 font-weight-bold text-muted">
                           Payout <span class="text-primary font-weight-bold">X533177888</span>
                        </td>
                        <td class="font-14 text-muted">
                           Transfer to Account ******8899
                        </td>
                        <td class="font-14 font-weight-bold text-muted">
                           $176,88
                        </td>
                        ...
                        <td>
                           <h5><span class="badge badge-success-lighten">Completed</span></h5>
                        </td>
                     ...
                     <tr>
                        ...
                        <td>
                           <h5><span class="badge badge-danger-lighten">Refund</span></h5>
                        </td>
                        <td class="text-center elipsis-click">
                           <button class="elipsis-click-icon dropdown-toggle" type="button" id="dropdownMenu2"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <tr>
                        ...
                        <td class="font-14 text-muted">
                           <span class="text-danger font-weight-bold">Refund</span> <span
                              class="text-primary font-weight-bold">X533177888</span>
                        </td>
                        <td class="font-14 text-muted">
                           Transfer to Account ******8899
                        </td>
                        <td class="font-14 text-muted">
                           <span class="text-danger font-weight-bold ">-$176,88</span>
                        </td>
                        <td class="font-14 font-weight-bold text-muted">
                           $176,88
                        </td>
