...
<div class="main_body_content ml-0  bg-secondary create-ad-section return-management-system create-new-invoice" style="padding-bottom:80px">
	...
	<div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
			<div class="text-center position-relative mx-3">
				...
				<div class="midtitle custom-mid align-self-center font-26">Delivery Note</div>
			</div>
					...
					<div class="ps-section--shopping w-100 d-inline-block p-4 ps-invoice-details">
						<div class="w-100">
							<div class="ps-section__header text-left pb-4 d-flex align-items-center justify-content-between">	
								<div class="font-26 font-weight-500 desktop-view">Delivery Note</div>
							...
							<div class="ps-section--account-setting bg-white shadow radius-5">
								<div class="row py-5 m-0 shadow">
									<div class="col-md-12 col-lg-6 search-options">	
										<div class="d-flex align-items-center w-100">
											<input placeholder="Search Customer" class="form-group default-placeholder bg-secondary m-0 radius-5 font-blue font-16 mr-4 serch-customer">
											<div uk-drop="mode: click" class="searchs__results hidden bg-white uk-drop uk-drop-bottom-left">
												<div class="p-3">
													<ul>
														<li class="justify-content-between pb-2 align-items-center hover-grey radius-5">
															<a href="#" class="p-2 d-inline-block">
																<span class="d-block font-14 text-dark font-weight-500 line-height-default">Brinkert, Stefanie</span>
														...
														<li class="justify-content-between pb-2 align-items-center hover-grey radius-5">
															<a href="#" class="p-2 d-inline-block">
																<span class="d-block font-14 text-dark font-weight-500 line-height-default">Meier, Stefan</span>
																<span class="d-block font-13 text-dark line-height-default">
											...
											<input placeholder="Search product" class="form-group default-placeholder bg-secondary m-0 radius-5 font-blue font-16 ml-4 search-product">
											<div uk-drop="mode: click" class="searchs__results hidden bg-white uk-drop uk-drop-bottom-left">
												<div class="p-3">
									...
									<div class="col-md-12 col-lg-6 action-options">
										<div class="text-right">
											<button class="btn btn-primary px-4 font-15 py-0 h-40 radius-5" data-toggle="modal" data-target="#Addservice">Add Service</button>
											<button class="btn btn-primary px-4 font-15 ml-4 py-0 h-40 radius-5" data-toggle="modal" data-target="#Addvoucher">Add Voucher / Gift Card</button>
										</div>
									</div>
								</div>
									...
									<div class="col-lg-12 create-new-invoice-section">
										<div class="invoice-detail mt-0">
												...
												<div class="row color-default">
													<div class="col-lg-7 col-xl-7">
														<div class="upload-banner d-flex align-items-center" >
															<span class="ml-3 font-weight-500 text-dark font-26">Buddy Shop</span>
														</div>
														<div class="shop_detailbox">
															<p class="mb-2 font-blue font-16">Buddy Shop - 1888 East Road, Green End, Mountain View, CA, 93088</p>
															<div class="row mt-4">
																<div class="col-sm-6">
													...
													<div class="col-lg-5 col-xl-5 position-relative">
														<div class="invoice-detilas-limit position-relative">
															<img src="assets/images/barcode.png" class="position-absolute top-0 right-0">
															...
															<div class="border-bottom py-2">
																<p class=" font-blue"><span class="font-weight-600">Telephone:</span>12345678</p>
																<p class="pt-1 font-blue"><span class="font-weight-600">email:</span>buddyshop@staytoenjoy.com</p>
																<p class="pt-1 font-blue"><span class="font-weight-600">Fax:</span>12345678</p>
															</div>
															<div class="border-bottom py-2">
																<p class=" font-blue"><span>Mountain View:</span>14. June 2020</p>
															</div>
															<div class="py-2">
																<p class="summary_box1 font-blue"><span class="font-weight-600 ">Invoice No.:</span><span class="sum_title1">12345678</span></p>
																<p class="pt-1 font-blue"><span class="font-weight-600">Customer No.:</span>12345678</p>
																<p class="pt-1 font-blue"><span class="font-weight-600">Invoice Date:</span><span id="dateget1">14.June  2020</span></p>
																<p class="pt-1 font-blue"><span class="font-weight-600">Due Date:</span><span id="dateget">24. June 2020</span></p>
																<p class="pt-1 pb-3 font-blue"><span class="font-weight-600">Your VAT ID:</span>DE24888 888 888</p>
																<p class="pt-1 font-blue"><span class="font-weight-600">PAN No:</span>AESP</p>
																<p class="pt-1 font-blue"><span class="font-weight-600">GST Registration No:</span> XXXXXXXXXXXXXXXXXX</p>
																<div class="d-inline-block">
																	<p class="pt-1 font-blue font-14"><span>Order Date:</span>Jan 17,2018</p>
											...
											<div class="color-default table-responsive">
												<table class="table table-striped table-bordered mb-0 product-info-table color-default font-weight-600">
													<thead>
														<tr>
													...
													<tbody class="radius-4">
														<tr>
															...
															<td class="vertical-middle" class="font-weight-normal">
																<textarea onkeyup="textAreaAdjust(this)" class="form-control bg-white border font-13 radius-5 px-3 py-2 w-100 h-40" style="overflow:hidden;min-height: 50px !important;">Yamaha Dolby Sourround Reciever XTR - 2211</textarea>
															</td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$100"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="2"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$200"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="10%"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="VAT"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100 " type="text" value="$20"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$220"></td>
														</tr>
														<tr>
															<td class="vertical-middle">2</td>
															<td class="vertical-middle" class="font-weight-normal">
																<textarea onkeyup="textAreaAdjust(this)" class="form-control bg-white border font-13 radius-5 px-3 py-2 w-100" style="overflow:hidden;min-height: 50px !important;">Headphone Yamaha HPH-100WH</textarea>
															</td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$100"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="2"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$200"></td>
														...
														<tr>
															...
															<td class="vertical-middle" style="width:250px;" class="font-weight-normal">
																<textarea onkeyup="textAreaAdjust(this)" class="form-control bg-white border radius-5 px-3 py-2 w-100 font-13" style="overflow:hidden;min-height: 50px !important;">Studiomonitor activ, Frequenzbereich 43 Hz - 30 kHz, System für 95-Watt</textarea>
															</td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$100"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="2"></td>
															<td class="vertical-middle"><input class="bg-white border font-13 radius-5 px-3 w-100" type="text" value="$200"></td>
											...
											<div class="row p-4 color-default">
												<div class="col-md-6 col-lg-7 align-self-end">
													<p class="font-weight-600 font-blue">Notes:</p>
													<textarea onkeyup="textAreaAdjust(this)" class="form-control expand notetextarea border-0" style="overflow:hidden">Next month we have 30% off Tablets and Smartphones</textarea>
												</div>
												<div class="col-md-6 col-lg-5">
													<h4 class="font-weight-600">Thanks for your business!</h4>
												</div>
												<div class="col-md-12">
													<p class="font-weight-600 pt-4 font-blue" >Legal:</p>
													<textarea onkeyup="textAreaAdjust(this)" class="form-control expand font-12 legartextarea border-0" style="overflow:hidden; height: 250px;">Objections to the deliveries and services charged to you are in writing or by e-mail to buddyshop@gmail.com within 14 days of the invoice date our accounting department. After this period, the amounts are considered approved. In the event of subsequent cancellation of the payment through no fault of StayToEnjoy we will continue to charge the third-party bank fees charged to us. This fee is charged without sales tax, as it is a non-taxable exchange of services. We reserve the right to discontinue our services until our claims have been settled. In the event of a delay in payment, we charge interest of currently 10% for the period of delay  p.a. The net individual amounts are shown rounded to two decimal places. There may therefore be deviations in the subtotals or final amounts come, which are due to the rounded net individual amounts.</textarea>
												</div>
											</div>
	...
	<div class="modal-dialog box-shodow">
		<div class="modal-content">
					...
					<div>
						<div class="form-group">
							...
							<div class="our-custom-select custom-select-sale">
								...
								<ul class="options scroll-dropdown scroll-design scrollbox set-drpdn-big" style="height:300px;z-index:999">
									<li>Choose</li>
			...
			<div class="modal-footer d-flex blue-text-light">
				<div>
					<button type="button" class="btn btn-save cancel-btn p-3 shadow-none mr-2 trigger-close h-40 hover-grey" data-dismiss="modal">Delete</button>
				</div>
				<div class="ml-auto d-flex align-items-center">
					<button type="button" class="btn btn-save cancel-btn p-3 shadow-none mr-2 trigger-close h-40 hover-grey" data-dismiss="modal">Cancel</button>
					<button type="button" class="btn btn-save btn-primary hover-effect save-btn p-3 trigger-close h-40 ml-4" data-dismiss="modal">Save</button>
				</div>
			</div>
	...
	<div class="modal-dialog box-shodow">
		<div class="modal-content">
			...
			<div class="modal-footer d-flex blue-text-light">
				...
				<div class="ml-auto d-flex align-items-center">
					<button type="button" class="btn btn-save cancel-btn p-3 shadow-none mr-2 trigger-close h-40 hover-grey" data-dismiss="modal">Cancel</button>
					<button type="button" class="btn btn-save btn-primary hover-effect save-btn p-3 trigger-close h-40 ml-3" data-dismiss="modal">Add</button>
				</div>
			</div>
		</div>
	</div>
