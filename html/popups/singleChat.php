<!-- single chat box start -->
<div class="box-shodow radius-4 chatbox collapse align-self-end" id="chatbox1">
   <div id="chatblock" class="carousel slide" data-ride="carousel" data-interval="false">
      <div class="carousel-inner">
         <div class="chat-block">
            <div class="p-3 chat-header chathead">
               <div class="d-flex align-items-center">
                  <div class="position-relative">
                     <img src="assets/img/beimg.png" class="w-h-30px rounded-circle"> <a class="active-profile"
                        style="position: absolute;bottom: -2px; right: -5px;"><span
                           class="bg-success position-absolute status radius-25 profile-status nohover"></span></a>
                  </div>
                  <div class="ml-3">
                     <div class="mb-0 font-16 font-weight-600 color-default">
                        <div class="mt-0 d-flex align-items-center profiledropdown">
                           <span class="font-13 font-weight-400 color-default">Jenny Smith</span>
                           <div id="chatProfileDropdown" onclick="openChatOptions()" style="transition:.5s;"
                              class="mt-0 ml-2 cursor-pointer downarrow d-flex justify-content-center flex-column">
                              <img src="assets/img/downarrow.png" id="grdown" style=""
                                 class="mx-auto mt-1 width-100 downarrowicon">
                  ...
                  <div class="ml-auto">
                     <div class="d-flex header-call-icon">
                        <div class="chat-call-part videoCall-click mr-1 btn-grad">
                           <img src="assets/img/chat-icon/start-call-icon.svg" class="" alt="">
                           <span class="start-call-text">Start Call</span>
                        </div>
                        <!--<div class="mr-2 menuhover audioCall-click">
                        ...
                        <div class="mr-2 menuhover videoCall-click">
                        ...
                        <div class="menuhover closeChat closechatprivate">
            ...
            <div class="position-relative gListclass">
               <div id="singleChatOptions"
                  class="px-5 pt-4 bg-white position-absolute h-100 w-100 border-top d-flex flex-column"
                  ...
                  <a class="px-4 py-2 dropdown-item d-flex align-items-center" data-toggle="modal"
                     data-target="#snoozeconversation" href="javascript:void(0);">
                  ...
                  <a class="px-4 py-2 dropdown-item d-flex align-items-center" data-toggle="modal"
                     ...
                     <figure class="chat-dropdown-image-wrap"><img src="assets/img/chat-icon/ignore-message-black.svg"
                           alt=""></figure>
                     <span class="ml-4 font-15"> Ignore Message</span>
                  </a>
                  <!--<a class="px-4 py-3 mt-3 dropdown-item d-flex align-items-center dltmsgpopup-click"
                     href="javascript:void(0);">
                  ...
                  <a class="px-4 py-2 dropdown-item d-flex align-items-center" data-toggle="modal"
                     ...
                     <figure class="chat-dropdown-image-wrap"><img src="assets/img/chat-icon/block-red-icon.svg" alt="">
                     </figure>
               ...
               <div class="max-h-320" id="descnote" data-simplebar>
                  <div class="pt-2 pb-0 pl-3 pr-4 chat-body w-scroll">
                     ...
                     <div class="request-come mt-4">
                        <div class="pb-4">
                           <span class="call-history-time">1/1/22, 23:46</span>
                        </div>
                        <div class="user-pic-come">
                           <img src="assets/images/user-profile-cover-img.jpg" alt="">
                        </div>
                        <p class="request-come-text">Susan would like to get in touch with you.
                        </p>
                        <div class="accept-btn-panel">
                           <button class="menuhover tooltip position-relative accept-button">
                              <img src="assets/img/chat-icon/like-thumb.svg" class="imgnone" alt="">
                              <img src="assets/img/chat-icon/like_hover.svg" class="imgblock" alt="">
                              <span class="tooltiptext top">Accept request</span>
                           </button>
                           <button class="menuhover tooltip position-relative">
                              <img src="assets/img/chat-icon/trash-gradient.svg" class="imgnone" alt="">
                              <img src="assets/img/chat-icon/trash-hover.svg" class="imgblock" alt="">
                              <span class="tooltiptext top">Delete request</span>
                           </button>
                        </div>
                        <div class="common-message">
                           <button id="say-hi">Say hi <img src="assets/img/chat-icon/s-icon-20.svg" width="30"></button>
                           <button id="say-hello">Hello <img src="assets/img/chat-icon/s-icon-20.svg"
                                 width="30"></button>
                           <button id="say-how-r-u">How are you? <img src="assets/img/chat-icon/s-icon-20.svg"
                                 width="30"></button>
                        </div>
                     </div>
                     <div class="d-none full-chat-panel">
                        <div class="pb-3 mt-4 mb-2 chat-row sender position-relative say-hi-message d-none">
                           <div
                              ...
                              <p class="d-flex align-items-center">Hi <img src="assets/img/chat-icon/s-icon-20.svg"
                                    width="15" class="ml-1"></p>
                           </div>
                        ...
                        <div class="pb-3 mt-4 mb-2 chat-row sender position-relative say-hello-message d-none">
                           <div
                              class="py-3 pl-3 pr-4 text-right bg-primary font-15 font-weight-400 messgebox radius-20 position-relative">
                              <time>1/1/22, 10:22</time>
                              <p class="d-flex align-items-center">Hello <img src="assets/img/chat-icon/s-icon-20.svg"
                                    width="15" class="ml-1"></p>
                           </div>
                           <div class="d-flex editPoints">
                              <div class="viewer-img">
                        ...
                        <div class="pb-3 mt-4 mb-2 chat-row sender position-relative say-how-r-u-message d-none">
                           <div
                              class="py-3 pl-3 pr-4 text-right bg-primary font-15 font-weight-400 messgebox radius-20 position-relative">
                              <time>1/1/22, 10:22</time>
                              <p class="d-flex align-items-center">How are you? <img
                                    src="assets/img/chat-icon/s-icon-20.svg" width="15" class="ml-1"></p>
                           </div>
                           <div class="d-flex editPoints">
                              <div class="viewer-img">
                                 <img src="assets/img/beimg.png" class="rounded-circle">
                        ...
                        <div class="call-history">
                           <span class="call-history-time">1/1/22, 23:46</span>
                           <h6 class="call-history-title">Call with Jens <span
                                 class="call-history-duration">29Sec</span>
                           </h6>
                        </div>
                        <div
               ...
               <div class="p-3 chat-footer border-top">
                  <div class="d-flex dropdown chat-box-icon plus-icon-showbox" id="plus-icon-showbox">
                     <div class=" menuhover dropdown-toggle tooltip position-relative upload-photo-click"
                     ...
                     <div class="border-0 dropdown-menu box-shodow font-14">
                        <a class="px-4 py-2 dropdown-item d-flex color-default" href="#" id="uploadimg">
                           <img src="assets/img/chat-icon/upload-photo.svg" class="w-h-32px"> <span class="mt-2 ml-2">
                  ...
                  <div class="mb-0 form-group senderblock">
                     <div class="d-flex justify-content-between align-items-end input-group">
                        <div class="pl-0 pr-0 mr-2 input-group-text menuhover chatplus-icon" id="chatplus-icon-private">
                           ...
                           <div class="d-flex dropdown chat-box-icon">
                              <div class="dropdown icon icons-dropdown">
                                 <div class="ml-2 menuhover dropdown-toggle tooltip position-relative"
                                    ...
                                    <span class="tooltiptext font-12 top chat-bottom line-height-default">Emoji</span>
                                 </div>
                                 <div class="border-0 max-h-200 emoji-box dropdown-menu box-shodow font-14">
                                    <div class="top-tab-panel w-scroll" id="emoji-box-top">
                                       <section id="one">
                                          ...
                                          <ul class="smiley-switcher uk-margin">
                                             <li class="uk-tab-li">
                                                ...
                                                <ul>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/007-arepa.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/009-tapa.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/014-bbq.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/015-mac.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/016-latte.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/020-donut.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/021-pie.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/024-ramen.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/029-sushi.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/034-crepe.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/046-taco.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/047-pizza.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/050-soda.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/056-water.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/057-milk.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/059-soda.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/064-beer.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/065-wine.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/068-juice.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/074-vodka.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/084-punch.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/fast-food/088-beers.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                          ...
                                          <ul class="smiley-switcher uk-margin">
                                             <li class="uk-tab-li">
                                                ...
                                                <ul class="d-flex">
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Birthday/005-cupcake.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Birthday/017-birthday cake.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/002-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/003-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/004-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/005-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/006-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Creativitty/007-creativity.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Food/007-spaghetti.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Nature/003-dragonfly.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/002-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/003-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/004-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/005-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/006-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/NewYear/007-newyear.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Sience-Fiction/014-meteorite.svg"
                                                         alt="">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Sport/001-basketball.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Sport/003-running.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Sport/005-football.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Sport/006-baseball.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Spring/001-flowers.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Spring/002-flowers.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Spring/004-flowers.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Spring/006-flower.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Spring/010-envelope.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Summer/009-popsicle.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Summer/010-cocktail.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Weather/004-autumn.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Weather/005-cloudy.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Weather/006-raining.svg" alt="">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/stickers/Wedding/007-balloons.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Wedding/017-flowers.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Wedding/019-groom.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/001-workout.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/002-workout.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/003-workout.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/004-workout.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/005-workout.svg" alt="">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/stickers/Workout/006-workout.svg" alt="">
                                                   </li>
                                                </ul>
                                             </li>
                                          </ul>
                                          ...
                                          <ul class="smiley-switcher uk-margin">
                                             <li class="uk-tab-li">
                                                ...
                                                <ul class="d-flex">
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/003-passion.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/004-ribbon.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/009-camera.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/010-loving.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/021-letter.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/023-hearts.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/025-surprise.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/029-balloons.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/031-candle.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/034-diamond.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/036-target.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/037-cupcake.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/042-kissing.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/044-necklace.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/045-letter.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/hearts/049-glasses.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                          ...
                                          <ul class="smiley-switcher uk-margin">
                                             <li class="uk-tab-li">
                                                ...
                                                <ul>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/objects/003-check.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/objects/009-hammer.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/objects/020-razor.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/objects/024-spray.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                      <img
                                          ...
                                          <ul class="smiley-switcher uk-margin">
                                             <li class="uk-tab-li">
                                                ...
                                                <ul class="d-flex">
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/pets/013-elephant.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/pets/024-red-panda.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <img src="assets/images/chat-smiley-icons/pets/027-crocodile.svg"
                                                         width="30">
                                                   </li>
                                                   <li>
                                    ...
                                    <ul class="nav nav-pills" id="emoji-option">
                                       <li class="active" id="opt-one">
                                          <a href="#one" class="menuhover tooltip position-relative">
                                             <span class="tooltiptext left right-0">Smiley</span>
                                             <img src="assets/images/chat-smiley-icons/emoji-grey.svg" class="imgnone"
                                                alt="">
                                             <img src="assets/images/chat-smiley-icons/emoji-blue.svg" class="imgblock"
                                                alt="">
                                          </a>
                                       </li>
                                       <li id="opt-two">
                                          <a href="#two" class="menuhover tooltip position-relative">
                                       ...
                                       <li id="opt-three">
                                          <a href="#three" class="menuhover tooltip position-relative">
                                       ...
                                       <li id="opt-four">
                                          <a href="#four" class="menuhover tooltip position-relative">
                                             <span class="tooltiptext left right-0">Sticker</span>
                                             <img src="assets/images/chat-smiley-icons/sticker-grey.svg" class="imgnone"
                                                alt="">
                                       ...
                                       <li id="opt-five">
                                          <a href="#five" class="menuhover tooltip position-relative">
                                             <span class="tooltiptext left right-0">Hearts</span>
                                             <img src="assets/images/chat-smiley-icons/hearts-grey.svg" class="imgnone"
                                                alt="">
                                             <img src="assets/images/chat-smiley-icons/hearts-blue.svg" class="imgblock"
                                                alt="">
                                          </a>
                                       </li>
                                       <li id="opt-six">
                                          <a href="#six" class="menuhover tooltip position-relative">
                                             <span class="tooltiptext left right-0">Objects</span>
                                             <img src="assets/images/chat-smiley-icons/objects-grey.svg" class="imgnone"
                                                alt="">
                                       ...
                                       <li id="opt-seven">
                                          <a href="#seven" class="menuhover tooltip position-relative">
