   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Refund</div>
         </div>
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Refund Overview</div>
      ...
      <div class="margin-0-auto exmt-10">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Refund
				<p class="d-block font-16 greyText-color">Find all Products you list </p>
			</div>-->
         <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5">
            <table id="vendor-return-overview" class="display table table-responsive" style="width:100%">
               <thead>
                  <tr>
                     <th class="order-id">Order ID</th>
                     <th>Customer Name</th>
                     <th class="created-at">Created</th>
                     <th class="maximum">Product</th>
                     <th class="return-type">Refund Type</th>
                     <th class="return-reason">Refund Reason</th>
               ...
               <tbody>
                  <tr>
                     ...
                     <td>Behrmann, Jens</td>
                     <td>May 3, 2020</td>
                     <td class="maximum">Sony STR-DH190 Stereo Receiver 2x100 W, black Bluetooth</td>
                     <td>Refund</td>
                     <td>Wrong Color</td>
                     <td class="text-center">
                        <span
                           class="payment_status paid w-100 p-1 d-inline-block radius-5 badge-danger-lighten font-12 payment-required">New</span>
                     </td>
                     <td>
                        <div class="usage_limits_checkbox mr-3">
                           <div class="radio_btn_part checkbox_btn_part">
                              <input type="checkbox" name="limit1" class="checkbox_input d-none" id="limit1">
                              <label for="limit1" class="d-flex align-items-center justify-content-center m-0">
                                 <span
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <span
                           class="payment_status w-100 p-1 d-inline-block paid radius-5 font-12 badge-success-lighten payment-complited">Completed</span>
                     </td>
                     <td>
                        <div class="usage_limits_checkbox mr-3">
                           <div class="radio_btn_part checkbox_btn_part">
                              <input type="checkbox" name="limit2" class="checkbox_input d-none" id="limit2">
                              <label for="limit2" class="d-flex align-items-center justify-content-center m-0">
                                 <span
                                    class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                    <i class="fa fa-check font-12"></i>
                                 </span>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <span
                           class="payment_status w-100 p-1 d-inline-block paid radius-5 font-12 badge-info-lighten payment-complited text-primary">Pending</span>
                     </td>
                     <td>
                        <div class="usage_limits_checkbox mr-3">
                           <div class="radio_btn_part checkbox_btn_part">
                              <input type="checkbox" name="limit3" class="checkbox_input d-none" id="limit3">
                              <label for="limit3" class="d-flex align-items-center justify-content-center m-0">
                                 <span
                                    class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                    <i class="fa fa-check font-12"></i>
                                 </span>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <span
                           class="payment_status w-100 p-1 d-inline-block paid radius-5 badge-warning-lighten font-12 payment-pending">Pending</span>
                     </td>
                     <td>
                        <div class="usage_limits_checkbox mr-3">
                           <div class="radio_btn_part checkbox_btn_part">
                              <input type="checkbox" name="limit4" class="checkbox_input d-none" id="limit4">
                              <label for="limit4" class="d-flex align-items-center justify-content-center m-0">
                                 <span
                                    class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                    <i class="fa fa-check font-12"></i>
                                 </span>
