...
<main class="main_body_content return-management-system ml-0">
	...
	<!--<div class="d-flex align-items-start pt-5 mt-4 mb-4 pl-5">
		...
		<div class="px-4 font-26 font-weight-500 desktop-view pt-2">Product Detail Page
		</div>
	</div>-->
											...
											<div class="d-flex">
													<div class="lefttab-part">
														<div class="d-flex align-items-start pt-3 mb-4">
															<div class="menuhover align-self-start tooltip position-relative" id="second-slide-btn" data-slide="next">
																<img src="assets/image/roundback.svg" width="35" class="imgnone left_arrow prev-step"/>
																<img src="assets/image/roundback.svg" width="35" class="left_arrow prev-step imgblock"/>
																<span class="tooltiptext right font-12">Back to Dashboard</span>
															</div>
															<div class="px-4 font-26 font-weight-500 desktop-view pt-2">Upload Product File<span class="line-height1.5 font-14 d-block">
																	You can upload Audio File, Video File, PDF, DOC, XLS, JPG, .PNG</span>
															</div>
														</div>
																...
																<div class="p-4 form-font">
																	<div class="row">
																		<div class="col-md-2 align-self-top">
																			<label data-toggle="tooltip" data-placement="right" title="lorem ipsum">
																			Upload&nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i>
																			</label>
																		</div>
																		<div class="col-md-10">
																			<div class="bg-secondary radius-5 mb-3">
																				<div class="clearfix round-15" style="text-align: center; margin: 0 auto;">
																							...
																							<div class="uploadicons-wrap mb-4">
																								<div class="auction-img">
																									<div class="menuhover align-self-center">
																										<img src="assets/img/upload1.svg" class="imgnone" width="35">
																										<img src="assets/img/upload2.svg" class="imgblock" width="35">
																									</div>
																								</div>
																								<!-- <img src="assets/img/upload1.svg" width="35" /> -->
																							</div>
																							<p class="pt-0 font-14 line-height-10 auction-uploadtxt text-dark">Drag & Drop File</p>
																							<p class="pt-0 font-14 line-height-10 auction-uploadtxt text-dark">or</p>

																							<div class="uploadicons-wrap w-auto d-flex justify-content-center mt-4">
																								<input type="file" class="file-upload report_screenshot cursor-pointer" id="file-upload"/>
																								<p class="browse blue-browse-btn cursor-pointer auction-uploadtxt">Browse</p>
																							</div>
																							<div class="browser_upload uploadicons-wrap mt-0">
																								<ul class="upload_options m-0 p-0 py-2">
																									<li class="hover-grey d-flex align-items-center">
																										<img src="assets/image/monitor.svg" class="mr-2" alt="Upload from Computer" width="32">
																										<input type="file" class="report_screenshot" id="upload_from_computer1" name="upload_computer"/>
																										<label for="upload_computer">Upload from Computer</label>
																									</li>
																									<li class="hover-grey d-flex align-items-center">
																										<img src="assets/image/album.svg" class="mr-2" alt="Upload from Album" width="32">
																										<input type="file" class="report_screenshot" id="upload_from_ablumn1" name="upload_album"/>
																										<label  for="upload_album">Upload from Album</label>
																									</li>
																								</ul>
																							</div>
																						</div>
											...
											<div class="d-flex">
													<div class="lefttab-part">
														<div class="d-flex align-items-start pt-3 mb-4">
															...
															<div class="px-4 font-26 font-weight-500 desktop-view pt-2">Product Detail Page Digital<span class="line-height1.5 font-14 d-block">Please fill in the informations they are required to sell your products on StayToEnjoy</span>
															</div>
														</div>
														<div class="position-relative bg-white shop-wrap round-10 shop-wrap pt-0 ">
															...
															<div class="py-5 px-4 form-font">
																...
																<div class="position-relative grey-panel-dark px-4 pt-4 mb-5">
																	<div class="row mb-2">
																		<div class="col-md-3 align-self-center font-16 font-blue">
																			...
																			Manufacturer&nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i>
																			<span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span>
																			</label>
																		</div>
																		<div class="col-md-3">
																	...
																	<div class="row mb-4">
																		...
																		<label class="form-group col-md-1 text-right align-self-center font-16 font-blue" data-original-title="lorem ipsum" aria-describedby="tooltip459260">
																		Barcode:&nbsp;&nbsp;
																		</label>
																		<div class="col-md-4">
																			<div class="form-group">
																		...
																		<div class="col-md-9">
																			<div class="form-group mb-0 ">
																				<ul class="tags bg-white rounded py-3 px-4 d-flex align-items-center">
																					<li class="addedTag font-16 addedTag bg-secondary radius-5 text-dark px-4 py-2 d-inline-block mr-3 position-relative">Ecommerce
																					<span onclick="$(this).parent().remove();">x</span><input type="hidden" name="tags[]" value="Web Deisgn">
																					</li>
																					<li class="addedTag font-16 addedTag bg-secondary radius-5 text-dark px-4 py-2 d-inline-block mr-3 position-relative">Computer
																					<span onclick="$(this).parent().remove();">x</span><input type="hidden" name="tags[]" value="Web Deisgn">
																					</li>
																					<li class="addedTag font-16 addedTag bg-secondary radius-5 text-dark px-4 py-2 d-inline-block mr-3 position-relative">Smartphones
																					<span onclick="$(this).parent().remove();">x</span><input type="hidden" name="tags[]" value="Web Deisgn">
																					</li>
																					<li class="tagAdd taglist radius-5 text-dark d-inline-block my-1">  
																							<input type="text" id="search-field" placeholder="Enter your own here" class="search-field-pro border-0 bg-none shadow-none default-placeholder p-0" style="height: 30px;">
																					</li>
																				</ul>
																			</div>
																		</div>
																...
																<div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
																	<div>
																		<button type="button" id="second-slide-btn" class="bttn bttn-default font-blue hover-grey  left_arrow prev-step bg-secondary">Back</button>
																	</div>
																	<div class="clearfix d-inline-block">
																		<div class="row">
																			<div class="d-flex flex-wrap justify-content-end col-md-12 step-buttons">
												...
												<div class="lefttab-part">
													<div class="d-flex align-items-start pt-3 mb-4">
														...
														<div class="px-4 font-26 font-weight-500 pt-2">Additional Features
															<span class="line-height1.5 font-14 d-block">Please add specifications to your Product. This can be - Brand, Color, Dimensoin, Weight e.g. <a id="learn-more-specification" class="light-blue cursor-pointer" uk-toggle="target: #learn-more-popup"> Learn more </a> </span>
														</div>
													</div>	
												...
												<div class="lefttab-part">
													<div class="position-relative">
														<div class="d-flex align-items-start pt-3 mb-4">
															...
															<div class="px-4 font-26 font-weight-500 desktop-view pt-2">Manage digital product prices & variants
																		...
																		<div class="card border-0 shadow w-100 h-100">
																			<div class="card-body p-0">
																				<div class="d-flex align-items-center">
																					...
																					<div class="col-6"><p class="font-16 ml-4">Digital File</p></div>
																				</div>
																			</div>
																		</div>
																	</div>
																			...
																			<div class="card-body p-0">
																				<div class="d-flex align-items-center">
																					...
																					<div class="target-wrap">
																						<a href="javascript:void(0);" class="font-16 font-weight-400 blue-text text-muted active" data-toggle="modal" data-target="#category-modal">Select Target Group</a>
																						<ul class="tags bg-white rounded mb-0 px-0 d-flex align-items-center">
																							<li class="addedTag font-16 addedTag bg-secondary radius-5 text-dark px-4 py-1 mt-2 d-inline-block mr-3 position-relative">Men
														...
														<div class="d-block">
															<div class="d-flex align-items-start pt-5 mb-4 pl-3">
																<div class="px-4 font-26 font-weight-500 desktop-view pt-2">Digital File and Variants
																	<span class="line-height1.5 font-14 d-block">Add your pricing options related variants</span>
																</div>
															</div>
															<div class="ps-section--shopping w-100 d-inline-block pl-4 pr-4 py-0 ps-invoice-details">
																<div class="w-100">
																	<div class="row ">
																		<div class="col-12">
																				<div class="form-group mb-0 ">
																									<div class="ex-tags-input">
																										<input type="text" id="variantWant" value="Video 90 MIns, Directors Cut"  class="search-field-pro border-0 bg-none shadow-none default-placeholder p-0" placeholder="+Add file description" data-role="tagsinput" />
																									</div>
																								</div>
																		</div>
																	</div>
														...
														<div class="p-4 mt-4">
															<div class="row">
																...
																<div class="form-group mb-0 ">
																	<label for="" class="font-16 font-blue">Predefine which variants you want</label>
																		<div class="ex-tags-input">
																...
																<div class="col-md-6 col-lg-6 col-12">
																<div class="form-group mb-0 ">
																	<label for="" class="font-16 font-blue">Predefine your subvariants</label>
																	<div class="ex-tags-input">
															...
															<div class="row">
																<div class="col-md-12">
																	...
																	<label for="" class="font-16 font-blue">Color</label>
																		<div class="ex-tags-input">
																			<input type="text" id="variantWant" value="Digital"  class="search-field-pro border-0 bg-none shadow-none default-placeholder p-0" placeholder="Please specify which variant values you want create" data-role="tagsinput" />
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-md-12">
																	...
																	<label for="" class="font-16 font-blue">Size</label>
																		<div class="ex-tags-input">
																			<input type="text" id="variantWant" value="Digital"  class="search-field-pro border-0 bg-none shadow-none default-placeholder p-0" placeholder="Please specify which sub variant values you want create" data-role="tagsinput" />
																		</div>
																	</div>
																</div>
															</div>
																			...
																			<div class=" tooltip position-relative">
																				...
																				<div class="card-body px-5 py-4">
																					<div class="form-body">
																						<div class="row">
																							<div class="col-12 col-md-6">
																								<h3 class="font-24 mt-3 mb-4">Video 90 Minutes</h3>
																							</div>
																						</div>
																																						...
																																						<div class="pricing-option-wrapper pr-2">
																																							<div class="d-flex pcol-flex mt-2 mb-2 align-self-center">
																																									<div class="col-lg-2 pr-1 pl-1">
																																														<label class="field-title font-14 tooltip position-relative">Price (gross) &nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i><span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span></label>
																																									...
																																									<div class="col pr-1 pl-1">
																																														<label class="field-title font-14 tooltip position-relative">Product SKU &nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i><span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span></label>
																																														<input type="text" class="form-control border-dark" name="stock" placeholder="STAYIN1234567888">
																																										</div>
																																										<div class="col pr-1 pl-1">
																																														<label class="field-title font-14 tooltip position-relative">Barcode, EAN, ISBN &nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i><span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span></label>
																																														<input type="text" class="form-control border-dark" name="stock" placeholder="Type Number">
																																										</div>
																																										<div class="col-lg-2 pl-0 pr-0">
																																														<label class="field-title font-14 tooltip position-relative">Downloads&nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i><span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span></label>
																																														<input type="text" class="form-control border-dark" name="stock" placeholder="Enter number">
																																										</div>
																																										<div class="col-lg-2 pl-0">
																																														<label class="field-title font-14 tooltip position-relative">Tax Rate &nbsp;&nbsp;<i class="fa fa-info-circle text-dark font-16"></i><span class="tooltiptext custom p-2 px-3 font-11">lorem ipsum</span></label>
																																														<div class="input-group">
																																																		<input type="text" class="form-control border-right-0" id="inlineFormInputGroupUsername2" placeholder="0,00">
																																																		<div class="input-group-prepend">
																																																						<div class="input-group-text">%</div>
																			...
																			<div class=" tooltip position-relative">
																				...
																				<div class="card-body px-5 py-4">
																					<div class="form-body">
																						<div class="row">
																							<div class="col-12 col-md-6">
																								<h3 class="font-24 mt-3 mb-4">Directors Cut</h3>
																							</div>
																						</div>
																																		<form action="/action_page.php">
																																						<div class="pricing-option-wrapper pr-2">
											...
											<div class="d-flex">
												<div class="lefttab-part">
													...
													<div class="position-relative bg-white round-10 shop-wrap">
														<div class="form-font">
															<div class="round-10 d-flex overflow-hidden for-mobile-wrap" style="text-align: center; margin: 0 auto;">
															...
															<div class="clearfix d-inline-block">
																<div class="row">
																	<div class="d-flex flex-wrap justify-content-end col-md-12 step-buttons">
																		<button type="button" name="button" class="bttn btn-default cancel  ml-3" value="Cancel" data-toggle="modal" data-target="#forcancle">Cancel</button>
																		<button type="submit" class="bttn bttn-default font-blue ml-3 gray-btn">Save as draft</button>
																		<button type="button" class="bttn bttn-primary ml-3 next-step image-new-right-offer">Next</button>
																	</div>
																</div>
															</div>
														</div>
											...
											<div class="d-flex">
												<div class="lefttab-part">
													...
													<div class="position-relative bg-white round-10 py-3 shop-wrap">
														...
														<h4 class="btm-heading mb-0">By click on List your Product you accept the <a href="">Terms & Conditions</a> from StayToEnjoy. <a href="">Visit the
															business Center</a>
														</h4>
														<div class="border-top bg-white text-center py-4  fixed-bottom">
														<div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
              ...
              <ul class="categories extras-add pr-0">
                <li>
                    <label for="Baby" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Baby</span></a>
                        <input type="checkbox" id="Baby" checked>
                    </label>
                </li>
                <li>
                    <label for="Infant" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Infant</span></a>
                        <input type="checkbox" id="Infant">
                    </label>
                </li>
                <li>
                    <label for="Kids" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Kids</span></a>
                        <input type="checkbox" id="Kids">
                    </label>
                </li>
                <li>
                    <label for="Men" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Men</span></a>
                        <input type="checkbox" id="Men" checked>
                    </label>
                </li>
                <li>
                    <label for="Women" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Women</span></a>
                        <input type="checkbox" id="Women" checked>
                    </label>
                </li>
                <li>
                    <label for="+60" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">+60</span></a>
                        <input type="checkbox" id="+60" checked>
                    </label>
                </li>
                <li>
                    <label for="All" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">All</span></a>
              ...
              <ul class="categories extras-add pr-0">
                <li>
                    <label for="Small" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Small</span></a>
                        <input type="checkbox" id="Small" checked>
                    </label>
                </li>
                <li>
                    <label for="Medium" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Medium</span></a>
                        <input type="checkbox" id="Medium">
                    </label>
                </li>
                <li>
                    <label for="Large" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Large</span></a>
                        <input type="checkbox" id="Large">
                    </label>
                </li>
                <li>
                    <label for="Extra-Large" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Extra Large</span></a>
                        <input type="checkbox" id="Extra-Large" checked>
                    </label>
                </li>
                <li>
                    <label for="X" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">X</span></a>
                        <input type="checkbox" id="X" checked>
                    </label>
                </li>
                <li>
                    <label for="XL" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">XL</span></a>
                        <input type="checkbox" id="XL" checked>
                    </label>
                </li>
                <li>
                    <label for="XXL" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">XXL</span></a>
          ...
          <div class="modal-body pl-4 pt-3 pr-4">
              ...
              <ul class="categories extras-add pr-0 w-scroll">
                <li class="first-button">
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Grosserie</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Fashion Women</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Electronics & Computer</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Books</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Home & Garden</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Baby Products</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Jewelry</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Pets</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Antiques</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
                <li>
                    <a class="d-flex justify-content-between align-items-center" href="#"><span class="pl-2">Art</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                </li>
              </ul>
          </div>
      </div>
             ...
             <ul class="categories extras-add pr-0 w-scroll">
                <li>
                    <label for="Fruits" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Fruits</span></a>
                        <input type="checkbox" id="Fruits" checked>
                    </label>
                </li>
                <li>
                    <label for="Vegetable" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Vegetable</span></a>
                        <input type="checkbox" id="Vegetable">
                    </label>
                </li>
                <li>
                    <label for="Purses" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Purses</span></a>
                        <input type="checkbox" id="Purses">
                    </label>
                </li>
                <li>
                    <label for="Fresh-Meat" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Fresh Meat</span></a>
                        <input type="checkbox" id="Fresh-Meat" checked>
                    </label>
                </li>
                <li>
                    <label for="Frozen-Meat" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Frozen Meat</span></a>
                        <input type="checkbox" id="Frozen-Meat" checked>
                    </label>
                </li>
                <li>
                    <label for="Milk-Products" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Milk&nbsp;Products</span></a>
                        <input type="checkbox" id="Milk-Products" checked>
                    </label>
                </li>
                <li>
                    <label for="Baverages" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Baverages</span></a>
                        <input type="checkbox" id="Baverages" checked>
                    </label>
                </li>
                <li>
                    <label for="Eggs" class="extras-add-label">
                        <a class="d-flex justify-content-between align-items-center" href="#"><span class="extras-add-title">Eggs</span></a>
