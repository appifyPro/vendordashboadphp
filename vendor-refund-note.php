   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Create Refund Note</div>
         </div>
            ...
            <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
               ...
               <div class="d-flex align-items-center">
                  <div class="tooltip position-relative center d-flex align-items-center">
                     ...
                     <div class="px-3 font-26 font-weight-500 desktop-view">Create Refund Note</div>
               ...
               <div class="ps-section--shopping w-100 d-inline-block p-4 ps-invoice-details">
                  <div class="w-100">
                     <!--<div class="ps-section__header text-left pb-4 d-flex align-items-center justify-content-between">
								<div class="font-26 font-weight-500 desktop-view">Create Refund Note
                              ...
                              <div class="invoice-detail mt-0">
                                 <div class="px-0 pt-0 pb-5">
                                    <div class="row color-default">
                                       <div class="col-lg-7 col-xl-7 align-self-end">
                                          ...
                                          <div class="shop_detailbox">
                                             <p class="mb-2 font-14 text-dark">Lynne K. Higby - 795 Folsom Ave, Suite
                                                600 - San Francisco, CA 94107</p>
                                             <div class="row mt-4">
                                                <div class="col-sm-6">
                                                   <h6 class="color-black font-14 address-heading">Return Address</h6>
                                                   <address class="text-dark font-nunito font-16 line-height1.5">
                                                      Buddy Shop<br>
                                                      1888 East Road<br>
                                                      Mountain View, CA 93088<br>
                                                   </address>
                                                </div>
                                             </div>
                                          </div>
                                       ...
                                       <div class="col-lg-5 col-xl-5 position-relative">
                                          <div class="invoice-detilas-limit position-relative">
                                             ...
                                             <div class="d-flex mb-2 align-items-center">
                                                <h1 class="font-24">GOODS RETURN NOTE</h1>
                                             </div>
                                             ...
                                             <div class="py-2">
                                                <p class="font-blue font-16 color-black bg-secondary p-2 mb-3 mt-1">GRTN
                                                   No: GRTN-555-999-888</p>
                                                <div class="d-inline-block">
                                                   ...
                                                   <p class="pt-1 font-blue font-14">
                                                      ...
                                                      <span
                                                         class="badge bg-success-new text-white float-right">Paid</span>
                                                   </p>
                                                   <p class="pt-1 font-blue font-14">
                                                      <span>Order ID:</span>
                                                      <span class="float-right">#123456</span>
                                                   </p>
                                                </div>
                                             </div>
                                          </div>
                                 ...
                                 <div class="color-default table-responsive">
                                    <table
                                       class="table table-striped table-bordered mb-0  color-default font-weight-600">
                                       <thead>
                                          <tr>
                                             <th class="serial-no">#</th>
                                             <th class="item">ITEM DESCRIPTION</th>
                                             <th
                                                class="bg-secondary text-capitalize color-black font-14 font-weight-500 border-right-0 border-left-0">
                                                Unit Price</th>
                                             <th
                                                class="bg-secondary text-capitalize color-black font-14 font-weight-500 border-right-0 border-left-0">
                                                QTY Delivered</th>
                                             ...
                                             <th
                                                ...
                                                Action</th>
                                             <th
                                                class="bg-secondary text-capitalize color-black font-14 font-weight-500 border-left-0">
                                             </th>
                                          </tr>
                                       </thead>
                                       <tbody class="radius-4">
                                          <tr>
                                             ...
                                             <td class="vertical-middle"><input
                                                   class="bg-white border font-13 radius-5 px-3 w-100" type="text"
                                                   value="Buy remorse"></td>
                                             <td class="vertical-middle"><input
                                                   class="bg-white border font-13 radius-5 px-3 w-100" type="text"
                                                   value="Exchange Product"></td>
                                             <td class="vertical-middle"><input
                                                   class="bg-white border font-13 radius-5 px-3 w-100" type="text"
                                                   value="$220"></td>
                                          </tr>
                                          ...
                                          <tr>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white"></td>
                                             <td class="border-bottom bg-white">$660.00 </td>
                                          </tr>
                                          ...
                                          <tr>
                                             ...
                                             <td class="bg-white"></td>
                                             <td class="bg-white"></td>
                                             <td class="bg-white">Subtotal 1</td>
                                             <td class="bg-white">$220.00 </td>
                                             <td class="bg-white">$220.00 </td>
                                          </tr>
                                          <tr>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale"></td>
                                             <td class="bg-blue-whale">GRAND TOTAL</td>
                                             <td class="bg-blue-whale">$220.00 </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </div>
                                 <div class="row mt-5 returnInformation">
                                    <div class="col-md-6">
                                       <div class="bg-white">
                                          <div class="package-recive mb-3 pb-3">
                                             <p class="font-16 color-black mb-3">Package received by Courier</p>
                                             <input placeholder="Type Airway Bill Number or by hands"
                                                name="package-recive"
                                                class="form-group bg-white border m-0 radius-5 default-placeholder font-14 color-black font-weight-400 return-info">
                                          </div>
                                          <div class="tracking-number mb-3 pb-3">
                                             <p class="font-16 color-black mb-3">Type Tracking Number</p>
                                             <input placeholder="www.dhl.trackingnumber.com" name="tracking"
                                                class="form-group bg-white border m-0 radius-5 default-placeholder font-14 light-blue  font-weight-400 return-info">
                                          </div>
                                          <div class="notes mb-3 pb-3">
                                             <p class="font-16 color-black mb-3">Notes</p>
                                             <input placeholder="Type your notes" name="notes"
                                                class="form-group bg-white border m-0 radius-5 default-placeholder font-14 color-black font-weight-400 return-info">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <p class="font-16 color-black mb-3">&nbsp;</p>
                                       <div class="our-custom-select w-100 custom-select-sale">
                                          <div class="selected-value">
                                             <div class="sel-value font-14 font-blue overflow-hidden"
                                                style="white-space:nowrap">Choose action</div>
                                             <input type="text" name="return-action" class="d-none">
                                          </div>
                                          <ul class="options scroll-dropdown scroll-design scrollbox">
                                             <li value="">Choose action</li>
                                             <li value="Full Refund">Full Refund</li>
                                             <li value="Partial Refund">Partial Refund</li>
                                             <li value="Convert to Voucher">Convert to Voucher</li>
                                             <li value="Convert to Credit Note">Convert to Credit Note</li>
                                          </ul>
                                       </div>
                                       <div class="action-area full-refund" style="display:none;">
                                          <div class="d-inline-block p-4">
                                             <p class="color-black font-18 mb-3">Full Refund to:</p>
                                             <p class="color-black font-15">Frank Miller</p>
                                             <p class="color-black font-15">Baltasarweg 5</p>
                                             <p class="color-black font-15">Oldenburg, 26131</p>
                                             <p class="color-black font-15">Germany</p>
                                             <p class="color-black font-15">E-Wallet Account</p>
                                             <p class="color-black font-15 mb-3">(***** *** 2288)</p>
                                             <p class="font-weight-500 color-black font-18">$550.00 available for refund
                                             </p>
                                          </div>
                                          <div class="text-right">
                                             <button type="button"
                                                class="bt bg-secondary radius-5 py-3 px-5 text-dark line-height1.5">Cancel</button>
                                             <button type="button"
                                                class="bt bg-light-blue ml-4 text-white radius-5 py-3 px-5 line-height1.5">Create
                                                Refund</button>
                                          </div>
                                       </div>
                                       <div class="action-area partial-refund" style="display:none;">
                                          <div class="d-inline-block p-4">
                                             <p class="color-black font-18 mb-3">Partial Refund to:</p>
                                             <p class="color-black font-15">Frank Miller</p>
                                             <p class="color-black font-15">Baltasarweg 5</p>
                                             <p class="color-black font-15">Oldenburg, 26131</p>
                                             <p class="color-black font-15">Germany</p>
                                       ...
                                       <div class="action-area convert-voucher" style="display:none;">
                                          <div class="d-inline-block p-4">
                                             <p class="color-black font-18 mb-3">Convert to Voucher to:</p>
                                             <p class="color-black font-15">Frank Miller</p>
                                             <p class="color-black font-15">Baltasarweg 5</p>
                                             <p class="color-black font-15">Oldenburg, 26131</p>
                                             <p class="color-black font-15 mb-3">Germany</p>
                                             <p class="font-weight-500 color-black font-18">$550.00 available for
                                                Voucher</p>
                                          </div>
                                          <div class="text-right">
                                             <button type="button"
                                       ...
                                       <div class="action-area convert-credit-note" style="display:none;">
                                          <div class="d-inline-block p-4">
                                             <p class="color-black font-18 mb-3">Convert to Credit Note to:</p>
                                             <p class="color-black font-15">Frank Miller</p>
                                             <p class="color-black font-15">Baltasarweg 5</p>
                                             <p class="color-black font-15">Oldenburg, 26131</p>
                                             <p class="color-black font-15 mb-3">Germany</p>
                                             <p class="font-weight-500 color-black font-18">$550.00 available for Credit
                                                Note</p>
                                          </div>
                                          <div class="text-right">
                                             <button type="button"
