   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Return Invoices Details</div>
         </div>
            ...
            <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
               ...
               <div class="d-flex align-items-center">
                  <div class="tooltip position-relative center d-flex align-items-center">
                     ...
                     <div class="px-3 font-26 font-weight-500 desktop-view">Return Invoices Details</div>
               ...
               <div class="clearfix d-inline-block">
                  <div class="row">
                     <div class="d-flex flex-wrap justify-content-end col-md-12 step-buttons">
                        <button type="button" class="bttn bttn-primary ml-3 next-step"><svg class="mr-2" height="17"
                              width="17" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                              version="1.1" x="0px" y="0px" viewBox="0 0 400 400"
                              style="enable-background:new 0 0 400 400;" xml:space="preserve" fill="#fff">
                              <g>
                                 <path
                                    d="M358.8,272.2v70.3c0,1.4-0.2,2.7-0.5,3.9v0c0,0,0,0,0,0c-1.4,6.9-7.5,12.1-14.7,12.1H56.3c-7.7,0-14.1-5.9-14.9-13.4   c-0.2-0.9-0.2-1.7-0.2-2.7v-70.3c0-8.3,6.8-15,15-15c4.1,0,7.9,1.7,10.6,4.4c2.7,2.7,4.4,6.5,4.4,10.6v56.3h257.7v-56.3   c0-8.3,6.8-15,15-15c4.1,0,7.9,1.7,10.6,4.4C357.1,264.3,358.8,268.1,358.8,272.2z" />
                                 <path
                                    d="M286.5,201.8l-73.7,73.7c-0.1,0.2-0.3,0.3-0.4,0.4c-2.7,2.7-6.2,4.4-9.7,4.9c-0.3,0-0.6,0.1-0.9,0.1   c-0.6,0.1-1.2,0.1-1.8,0.1h0l-1.7-0.1c-0.3,0-0.6-0.1-0.9-0.1c-3.6-0.5-7-2.2-9.7-4.9c-0.1-0.1-0.3-0.3-0.4-0.4l-73.7-73.7   c-3.4-3.4-5.1-7.9-5.1-12.4c0-4.5,1.7-9,5.1-12.4c6.8-6.8,17.9-6.8,24.8,0l44.3,44.3V59c0-9.6,7.9-17.5,17.5-17.5   c4.8,0,9.2,2,12.4,5.1c3.2,3.2,5.1,7.5,5.1,12.4v162.3l44.3-44.3c6.8-6.8,17.9-6.8,24.8,0C293.3,183.9,293.3,195,286.5,201.8z" />
                              </g>
                           </svg>
                           Download</button>
                        <button type="button" class="bttn bttn-primary ml-3 next-step"><i class="fa fa-print mr-2"></i>
                           Print</button>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row m-0 p-5 invoice-section">
                           <div class="col-lg-12 create-new-invoice-section">
                              <div class="invoice-detail mt-0">
                                 ...
                                 <!--<div class="row">
												<div class="col-md-6">
													<p class="font-weight-600 pt-4 font-18 font-blue" >Return Notes:</p>
													<div style="line-height: 1.2;" class="text-dark font-14 font-weight-300 my-4">
														 We have to talk with the carrier because this is the 3rd time in 1 month that a packaged is broken. 
													</div>
													<div class="usage_limits_checkbox">
														<div class="radio_btn_part checkbox_btn_part">
															<input type="checkbox" name="type" class="checkbox_input d-none" id="sendnotification">
															<label for="sendnotification" class="d-flex align-items-center">
																<span class="checkbox_btn text-center d-flex justify-content-center align-items-center cursor-pointer">
																	<i class="fa fa-check font-12"></i>
																</span>
																<p class="ml-3 font-14 font-weight-500 font-blue">Send a notification to the customer</p>
															</label>
														</div>
													</div>
												</div>
												<div class="col-md-6 text-right">
													<div class="d-inline-block p-4 bg-secondary text-left">
														<p class="font-blue font-15 mb-3">REFUND to: PARTICAL REFUND to: SEND NEW ITEM to:</p>
														<p class="font-blue font-15 mb-3">MangoPay Payments</p>
														<p class="font-blue font-15 mb-3">Jens Behrmann</p>
														<p class="font-blue font-15 mb-3">E-Wallet Account</p>
														<p class="font-blue font-15 mb-3">(***** *** 2288)</p>
														<p class="font-weight-500 font-blue font-14">$550.00 available for refund</p>
													</div>
												</div>
											</div>
											<div class="text-right mt-5">
												<button type="button" class="bt bg-secondary radius-5 py-3 px-5 text-dark">Cancel</button>
												<button type="button" class="bt bg-blue hover-effect ml-4 text-white radius-5 py-3 px-5">Refund Partical Refund New Item $ 550.00</button>
											</div>-->
                              </div>
                           </div>
                        </div>
