   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Flash Offer</div>
         </div>
      ...
      <div class="margin-0-auto">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Flash Offer</div>
            ...
            <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
               ...
               <div class="d-flex align-items-center">
                  <div class="tooltip position-relative center d-flex align-items-center">
                     ...
                     <div class="px-3 font-26 font-weight-500 desktop-view">Flash Offer</div>
                  ...
                  <div class="col-lg-7 automated_dis_content">
                        ...
                        <div class="automated_dis_box border-0 pb-0">
                           <div class="row align-items-center">
                              <div class="col-md-12 mb-4">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Price & Disount</h4>
                              </div>
                              <div class="col-12 p-0">
                                 <div class="pricing-option-wrapper px-0 pt-3 pb-0">
                                    <div class="d-flex pcol-flex mt-2 align-self-center">
                                       <div class="col-12 col-lg-5">
                                          <label class="field-title font-14 tooltip position-relative">Regular
                                             Price</label>
                                       ...
                                       <div class="col-12 col-lg-5">
                                          <label class="field-title font-14 tooltip position-relative">Discount</label>
                                          <div class="input-group">
                                             <input type="text" class="form-control border-right-0"
                                          ...
                                          <small class="font-12 font-blue pl-1">The minimum discount you must give is
                                             20%</small>
                                       </div>
                                    </div>
                                 </div>

                                 <div class="pricing-option-wrapper px-0 pt-0 pb-3">
                                    <div class="d-flex pcol-flex mb-2 align-self-center">
                                       <div class="col-12 col-lg-5">
                                          <label class="field-title font-14 tooltip position-relative">Flash Offer
                                             Price</label>
                                          <div class="input-group">
                                             <input type="text" class="form-control border-right-0"
                                          ...
                                          <small class="font-12 font-blue pl-1">This is your flash offer sales
                                             price</small>
                                       </div>
                                    </div>
                                 </div>
                     ...
                     <div class="page_box mb-4 box-shodow  w-100 bg-white radius-5 p20">
                        <div class="automated_dis_box border-0 pb-0">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Flash Offer Date</h4>
                                 <p class="mb-4 font-14">Flash offer duration is 24 hours and it starts at midnight</p>
                              </div>
                              <div class="col-md-12">
