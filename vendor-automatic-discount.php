   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Add Personalized Discount</div>
         </div>
            ...
            <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
               ...
               <div class="d-flex align-items-center">
                  <div class="tooltip position-relative center d-flex align-items-center">
                     ...
                     <div class="px-3 font-26 font-weight-500 desktop-view">Add Personalized Discount</div>
                  ...
                  <div class="col-lg-7 automated_dis_content">
                     <div
                        ...
                        <div class="automated_dis_box">
                           <label class="m-0 color-default font-weight-500 py-0">Create Automatic Discount</label>
                           ...
                           <div>
                              ...
                              <!--<p class="text-right mt-2"><a href="javascript:;" class="generat_btn ml-2 font-14">Generate code</a></p>-->
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="row align-items-center">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div id="openproductlist" class="collapse show shop-bundel-section">
                                    <div class="input-group my-3 py-5 border-top border-bottom">
                                    ...
                                    <div class="product-details mt-5">
                                       <div class="d-inline-block text-center w-100">
                                          <div class="d-inline-block text-left">
                                             ...
                                             <p class="font-16"> <span class="text-warning fa fa-star"></span> <span
                                                   class="text-warning fa fa-star"></span> <span
                                                   class="text-warning fa fa-star"></span> <span
                                                   class="text-warning fa fa-star"></span> <span
                                                   class="text-warning fa fa-star"></span> </p>
                                          </div>
                                       </div>
                                       <div
                     ...
                     <div class="page_box mb-4 box-shodow  bg-white radius-5 w-100  p20">
                        <div class="automated_dis_box ">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <label class="m-0 color-default font-weight-500 py-0">Types</label>
                                 <p class="mb-4 font-14">Describe your offer with precise and meaningful words </p>
                              </div>
                              <div class="col-md-12">
                                    ...
                                    <div class="px-0 col-md-3">
                                       <div class="radio_btn_part">
                                          <label for="buy" class="d-flex align-items-center">
                                             <input type="radio" name="type" class="radio_input mr-3" id="buy"> Buy X
                                             get Y </label>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row align-items-center">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 p-0 dis_box_part">
                                       <div class="input-group dis_input mb-3" id="perc">
                                          <input type="text" class="form-control border-right-0" placeholder="">
                                          <div class="input-group-prepend">
                                             <div class="input-group-text">%</div>
                                          </div>
                                       </div>
                                       <div class="input-group amount_input dis_input m-0" id="fixAm">
                                          <input type="text" class="form-control border-right-0" name="fixed_amount"
                                             placeholder="">
                                          <div class="input-group-prepend">
                                             <div class="input-group-text">€</div>
                                          </div>
															...
															<div class="search_input" style="flex: 1;">
																<div class="search_box">
																	<div class="search_box">
																								...
																								<div class="max-h-320 overflow-auto scroll-design">
																									<div class="clearfix d-flex align-items-center border-top hover-effect px-3 py-3">
																										<div class="radio_btn_part chec_c_btn_part mr-2">
																											...
																											<label for="img3" class="d-flex align-items-center"> <span class="radio_btn">																												</span> </label>
																										</div>
																										<div class="d-flex align-items-center pro_img">
																											<figure class="mr-3"> <img src="assets/img/product.png" alt=""> </figure>
																											<p>IPhone</p>
																										</div>
																									</div>
																									<div class="clearfix d-flex border-top hover-effect px-3 py-3">
																										<div class="radio_btn_part chec_c_btn_part mr-2">
																											...
																											<label for="img4" class="d-flex align-items-center"> <span class="radio_btn">																												</span> </label>
																										</div>
																										<div class="d-flex align-items-center pro_img">
																											<figure class="mr-3"> <img src="assets/img/product.png" alt=""> </figure>
																											<p>IPhone</p>
																		...
																		</div> <span class="fa fa-search search_icon"></span> </div>
																</div>
															</div>
															<div class="input-group-append"> <a href="#" data-toggle="modal" data-target="#browse" class="btn font-12 btn-primary">Browse</a> </div>
														</div>
													</div>-->
                                    </div>
                                 </div>
											...
											<div class="col-md-12">
												...
												<div class="row mt-3 ">
													<div class="col-md-4 form-group">
														<p class="mb-1">Quantity</p>
														<input type="number" name="quantity" class="form-control"> </div>
													<div class="col-md-8 form-group">
														<p class="mb-1">Any items from</p>
														<select class="form-control w-100 specific_select">
                                    ...
                                    <li class="mb-1">
                                       <div class="radio_btn_part">
                                          ...
                                          <div class="amount_input_part" id="min1" style="display: none;">
                                             <div class="input-group amount_input d-flex">
                                                <input type="text" class="form-control border-right-0" id="pur_amount"
                           ...
                           <div class="row align-items-center">
                              ...
                              <div class="col-md-12 usage_limits_checkbox">
                                 ...
                                 <div class="radio_btn_part checkbox_btn_part">
                                    ...
                                    <label for="setEnddate" class="d-flex align-items-center"> <span
                                          class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                          <i class="fa fa-check font-12"></i> </span>
                        ...
                        <div class="page_box p-0 mb-4 box-shodow bg-white radius-5">
                           <div class="p20 border-bottom">
                              ...
                              <div class="d-flex align-items-center"> <span
                                    class="badge avilable-type pb-2 mr-4 font-nunito px-3 py-2"
                                    style="background:#C6FFC1;color:#000">Ongoing</span> <span
                                    class="badge font-nunito pb-2 px-3 py-2" style="background:#C6FFC1;color:#000">Ends
                                    on 20. July 2021</span> </div>
                           </div>
                           <div class="d-flex flex-wrap align-items-center p20 border-bottom"> <span
                                 class="badge badge-info-lighten font-13 mr-4">10% off Entire Order</span> <span
                                 class="badge badge-info-lighten font-13 mr-4">Minumun Purchase $20,00</span> </div>
                           <div class="p20 pb-0 bundle-product-list show-budlelist">
                              <div class="d-flex added-bundle-product flex-wrap ps-carousel--nav owl-slider"
                                 ...
                                 <div class="productbox text-center w-100 m-0">
                                    <button class="close-red-text field-title tooltip position-change"><img
                                          src="img/close-new.svg" alt="" style="height: 10px;" /></button><img
                                       class="mx-auto" src="assets/images/products/product-2.jpg"
                                       style="height: 115px;border: 0;" />
                                    <p class="mt-3 text-muted font-13 line-height-default">Modern Chari Orange</p>
                                    <p class="mt-3 text-muted font-18 font-weight-600 line-height-default">$139.58</p>
                                 </div>
                                 <div class="productbox text-center w-100 m-0">
                                    <button class="close-red-text field-title tooltip position-change"><img
                                          src="img/close-new.svg" alt="" style="height: 10px;" /></button><img
                                       class="mx-auto" src="assets/images/products/product-3.jpg"
                                       style="height: 115px;border: 0;" />
                                    <p class="mt-3 text-muted font-13 line-height-default">Modern Chari Orange</p>
                                    <p class="mt-3 text-muted font-18 font-weight-600 line-height-default">$139.58</p>
                                 </div>
...
<!--<div class="sticky-footer"> By clicking of List Discount Button you agree to StayToEnjoy’s <a href="">Terms &amp; Conditions</a> <span class="text-primary">|</span> <a href="">Help Center</a> <a href="" class="btn btn-primary ml-3 font-12">List Discount</a></div>-->
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-header">
            ...
            <div class="menuhover ml-auto " data-dismiss="modal"> <img src="assets/img/header-icon/close.svg"
                  class="w-h-30px rounded-circle imgnone"> <img src="assets/img/header-icon/close-hover.svg"
                  class="w-h-30px rounded-circle imgblock" id="clsoespeech"> </div>
         </div>
         <!-- Modal body -->
         <div class="modal-body">
            <div class="product_content">
               <div class="search_box">
                  <input type="text" name="search" class="form-control"> <span class="fa fa-search search_icon"></span>
               </div>
                        ...
                        <tr>
                           <td>
                              <div class="radio_btn_part chec_c_btn_part">
                                 ...
                                 <label for="img" class="d-flex align-items-center"> <span class="radio_btn"> </span>
                                 </label>
                              </div>
                           </td>
                           <td>
                              <div class="d-flex align-items-center pro_img">
                                 <figure> <img src="assets/img/product.png" alt=""> </figure>
                                 <p>IPhone</p>
                              </div>
                           </td>
                           <td> 0 available </td>
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button> <a href="#"
   ...
   <div class="modal-dialog shadow-lg radius-5">
      <div class="modal-content">
         ...
         <div class="modal-header">
            ...
            <div class="menuhover ml-auto " data-dismiss="modal"> <img src="assets/img/header-icon/close.svg"
                  class="w-h-30px rounded-circle imgnone" width="30"> <img src="assets/img/header-icon/close-hover.svg"
                  class="w-h-30px rounded-circle imgblock" id="clsoespeech" width="30"> </div>
         </div>
         <!-- Modal body -->
         <div class="modal-body">
            <div class="product_content">
               <div class="search_box mb-4 " style="position: relative;">
                  <input type="text" name="search" placeholder="Search Countries" class="form-control pl-5"> <span
                     class="fa fa-search search_icon position-absolute"
                              ...
                              <div class="d-flex align-items-center">
                                 <div class="usage_limits_checkbox ">
                                    <div class="checkbox_btn_part">
                                       ...
                                       <label for="country1" class="d-flex m-0 align-items-center"> <span
                                             class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                             <i class="fa fa-check font-12"></i> </span> </label>
                                    </div>
                                 </div>
                                 <div class="d-flex align-items-center country_flag">
                                    <figure class="flag mb-0 mx-3"> <img src="assets/img/germany.svg" alt=""> </figure>
                                    <span>Germany</span>
                                 </div>
                              </div>
                           </td>
                              ...
                              <div class="d-flex align-items-center">
                                 <div class="usage_limits_checkbox ">
                                    <div class="checkbox_btn_part">
                                       ...
                                       <label for="country2" class="d-flex m-0 align-items-center"> <span
                                             class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                             <i class="fa fa-check font-12"></i> </span> </label>
                                    </div>
                                 </div>
                                 <div class="d-flex align-items-center country_flag">
                                    <figure class="flag mb-0 mx-3"> <img src="assets/img/greece.png" alt=""> </figure>
                                    <span>Greece</span>
                                 </div>
                              </div>
                           </td>
                              ...
                              <div class="d-flex align-items-center">
                                 <div class="usage_limits_checkbox ">
                                    <div class="checkbox_btn_part">
                                       ...
                                       <label for="country3" class="d-flex m-0 align-items-center"> <span
                                             class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                             <i class="fa fa-check font-12"></i> </span> </label>
                                    </div>
                                 </div>
                                    ...
                                    <div class="usage_limits_checkbox ">
                                       <div class="checkbox_btn_part">
                                          <input type="checkbox" name="type" class="checkbox_input d-none"
                                             id="country4">
                                          <label for="country4" class="d-flex m-0 align-items-center"> <span
                                                class="checkbox_btn text-center d-flex justify-content-center align-items-center">
                                                <i class="fa fa-check font-12"></i> </span> </label>
                                       </div>
                                    </div>
