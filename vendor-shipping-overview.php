...
<div
   class="main_body_content ml-0  bg-secondary create-ad-section loyalty-card-section return-management-system shop-bundel-overview"
   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Shipping Overview</div>
         </div>
         ...
         <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
            ...
            <div class="d-flex align-items-center">
               <div class="tooltip position-relative center d-flex align-items-center">
                  ...
                  <div class="px-3 font-26 font-weight-500 desktop-view">Shipping Overview</div>
      ...
      <div class="margin-0-auto exmt-10">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Shipping Overview
				<p class="d-block font-16 greyText-color">Find all Products you list </p>
			</div>-->
         <div class="dataTable-wrapper px-4 pb-5 pt-3 mb-5">
            <table id="vendor-shipping-overview" class="display table table-responsive" style="width:100%">
               <thead>
                  <tr>
                     <th class="font-nunito font-15 text-dark text-capitalize" style="min-width: 120px;">Order Date</th>
                     <th class="font-nunito font-15 text-dark text-capitalize" width="24%">Order Items</th>
                     <th class="font-nunito font-15 text-dark text-capitalize">Customer</th>
                     <th class="font-nunito font-15 text-dark text-capitalize text-center">Country</th>
                     <th class="font-nunito font-15 text-dark text-capitalize text-center">Price</th>
                     <th class="font-nunito font-15 text-dark text-capitalize text-center">Status</th>
                     <th class="font-nunito font-15 text-dark text-capitalize">Payment Status</th>
                     <th class="font-nunito font-15 text-dark text-capitalize text-center" style="width: 75px;">Action
                     </th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     <td class="text-body font-nunito table-user">
                        <div class="pl-2">July 20<p class="text-body font-nunito ">9:15AM</p>
                        </div>
                     </td>
                     <td class="text-body font-nunito" style="line-height: 1.2;min-width: 200px;">
                        <p>#1001</p>Sony STR-DH190 Stereo Receiver 2x100 W, black Bluetooth®
                     </td>
                     <td class="text-body font-nunito">
                        Jens Behrmann
                     </td>
                     <td class="text-body font-nunito text-center">
                        GER
                     </td>
                     <td class="text-body font-nunito text-center">
                        $5.99
                     ...
                     <td class="text-body font-nunito text-center">
                        <span class="badge badge-success-lighten">picked</span>
                     </td>
                     <td class="text-body font-nunito">
                        <span class="payment_status badge badge-danger-lighten paid radius-5">Payment Required</span>
                     </td>
...
<div class="modal fade feedbackmodal snooze" id="deleteOrder">
   <div class="modal-dialog">
      <div class="modal-content">
         <!-- Modal Header -->
         <p class="pt-3 pr-3"><button type="button" class="close" data-dismiss="modal">&times;</button></p>
         <!-- Modal body -->
         ...
         <!-- Modal footer -->
         <div class=" border-0 text-center pb-5 pt-3">
            <a type="button" class="btn mr-1" data-dismiss="modal">Cancel</a>
