   ...
   <div class="right-side-section">
      <div class="bg-white second_header body_content p-0 border-bottom mobile-view" style="z-index: 4500;">
         <div class="text-center position-relative mx-3">
            ...
            <div class="midtitle custom-mid align-self-center font-26">Delivery Settings</div>
         </div>
      ...
      <div class="margin-0-auto">
         <!--<div class="px-4 font-26 font-weight-500 pt-5 desktop-view">Delivery Settings</div>
            ...
            <div class="verification_right_part w-100 m-0 d-flex py-0 justify-content-between shop-listing">
               ...
               <div class="d-flex align-items-center">
                  <div class="tooltip position-relative center d-flex align-items-center">
                     ...
                     <div class="px-3 font-26 font-weight-500 desktop-view">Delivery Settings</div>
                  ...
                  <div class="col-lg-7 automated_dis_content">
                     <div class="page_box mb-4 box-shodow  w-100 bg-white radius-5 p20">
                        <div class="automated_dis_box border-0 pb-0">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Cut out time for same day delivery
                                 </h4>
                     ...
                     <div class="page_box mb-4 box-shodow w-100 bg-white radius-5 p20">
                        <div class="automated_dis_box pb-0">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Delivery to be done on weekly off
                                    day of the store</h4>
                                 <p class="mb-4 font-14">Describe your oofer with precise and meaningful words</p>
                              </div>
                              <div class="col-md-12">
                                 <div class="p-0 row mx-0 list-unstyled d-flex align-items-center py-4">
                                    <div class="px-0 col-md-5">
                                       <div class="radio_btn_part">
                                          <label for="delievery-yes" class="d-flex align-items-center">
                                             <input type="radio" name="deleiverydone" class="radio_input mr-3"
                                                value="Yes"> Yes </label>
                                       </div>
                                    </div>
                                    <div class="px-0 col-md-4">
                                       <div class="radio_btn_part">
                                          <label for="delievery-no" class="d-flex align-items-center">
                                             <input type="radio" name="deleiverydone" class="radio_input mr-3"
                                                value="No">No</label>
                                       </div>
                                    </div>
                           ...
                           <div class="row align-items-center timediv" id="vendorYes">
                              <div class="col-md-12">
                                 <div class="pricing-option-wrapper">
                                    <div class="row">
                                       <div class="w-100">
                     ...
                     <div class="page_box mb-4 box-shodow  bg-white radius-5 w-100  p20">
                        <div class="automated_dis_box ">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Delivery Radius</h4>
                                 <p class="mb-4 font-14">Describe your oofer with precise and meaningful words</p>
                              </div>
                              <div class="col-md-12">
                                 <div class="deleivery-radius-map">
                                    <img src="img/map-image.png" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="page_box mb-4 box-shodow  w-100 bg-white radius-5 p20">
                        <div class="automated_dis_box border-0 pb-0">
                           <div class="row align-items-center">
                              <div class="col-md-12">
                                 <h4 class="m-0 color-default font-weight-500 py-0">Set your start and end delivery time
                                 </h4>
                                 <p class="mb-4 font-14">Describe your oofer with precise and meaningful words</p>
                              </div>
                              <div class="col-md-12">
